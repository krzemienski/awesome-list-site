...
ALTER TABLE "research_discoveries" ADD CONSTRAINT "research_discoveries_job_id_research_jobs_id_fk" FOREIGN KEY ("job_id") REFERENCES "public"."research_jobs"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "research_discoveries" ADD CONSTRAINT "research_discoveries_created_resource_id_resources_id_fk" FOREIGN KEY ("created_resource_id") REFERENCES "public"."resources"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "research_jobs" ADD CONSTRAINT "research_jobs_started_by_users_id_fk" FOREIGN KEY ("started_by") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "idx_research_discoveries_job_id" ON "research_discoveries" USING btree ("job_id");--> statement-breakpoint
CREATE INDEX "idx_research_discoveries_status" ON "research_discoveries" USING btree ("status");--> statement-breakpoint
CREATE INDEX "idx_research_discoveries_url" ON "research_discoveries" USING btree ("url");--> statement-breakpoint
CREATE INDEX "idx_research_jobs_status" ON "research_jobs" USING btree ("status");--> statement-breakpoint
CREATE INDEX "idx_research_jobs_started_by" ON "research_jobs" USING btree ("started_by");--> statement-breakpoint
