...
export type LearningPreferencesValues = z.infer<
  typeof learningPreferencesValuesSchema
>;
export type LearningPreferencesUpdate = z.infer<
  typeof learningPreferencesUpdateSchema
>;
