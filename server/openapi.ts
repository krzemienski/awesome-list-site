 ...
 * ============================================================================
 *
 * Generates the OpenAPI (Swagger) specification for the public API endpoints.
 * This spec documents all public-facing REST endpoints for developers to
 * programmatically access resource data.
 *
 * FEATURES:
 ...
 *
 * This specification documents all public endpoints, including:
 * - Resources (list, get by ID)
...
\`\`\`
      ...
      Resource: {
        ...
        properties: {
          ...
          url: {
            type: 'string',
            format: 'uri',
            description: 'Resource URL (typically a video link)',
            example: 'https://www.youtube.com/watch?v=example',
          },
          description: {
            type: 'string',
            description: 'Resource description or summary',
            example: 'A comprehensive guide to React Hooks covering useState, useEffect, and custom hooks.',
          },
          category: {
            type: 'string',
          ...
          status: {
            ...
            description: 'Approval status (public API only returns approved resources)',
            example: 'approved',
          },
          submittedBy: {
            type: 'string',
            nullable: true,
            description: 'User ID who submitted the resource',
            example: 'user-uuid-123',
          },
          approvedBy: {
            type: 'string',
            nullable: true,
            description: 'User ID who approved the resource',
          ...
          approvedAt: {
            ...
            format: 'date-time',
            nullable: true,
            description: 'Timestamp when resource was approved',
            example: '2024-01-15T10:30:00Z',
          },
          githubSynced: {
            type: 'boolean',
            description: 'Whether resource has been synced to GitHub',
            example: true,
          },
          lastSyncedAt: {
            type: 'string',
          ...
          metadata: {
            type: 'object',
            description: 'Flexible metadata (AI enrichment, tags, etc.)',
      ...
      ApiKey: {
        ...
        properties: {
          ...
          scopes: {
            ...
            example: ['read:resources', 'read:tags'],
          },
          createdAt: {
            type: 'string',
            format: 'date-time',
          ...
          expiresAt: {
            ...
            format: 'date-time',
            nullable: true,
            description: 'Expiration timestamp (null if non-expiring)',
            example: null,
          },
          revokedAt: {
            type: 'string',
      ...
      PaginatedResourcesResponse: {
        ...
        properties: {
          resources: {
            ...
            description: 'Array of resources for current page',
          },
          total: {
            type: 'integer',
  ...
  paths: {
    '/api/public/resources': {
      get: {
        ...
        security: [
          { BearerAuth: [] },
          {}, // Also allow unauthenticated access (lower rate limit)
        ],
        parameters: [
          {
            name: 'page',
  ...
  tags: [
    {
      name: 'Resources',
      description: 'Operations for accessing curated video resources',
    },
    {
      name: 'Categories',
      description: 'Operations for accessing resource categories',
    },
    {
      name: 'Tags',
      description: 'Operations for accessing resource tags',
    },
  ],
};
