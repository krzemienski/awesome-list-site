...
async function captureScreenshot() {
  ...
  try {
    ...
    console.log('Loading category navigation demo HTML...');

    // Navigate to the demo HTML file
    const demoPath = 'file://' + process.cwd() + '/scripts/category-navigation-demo.html';
    ...
    // Save screenshot
    const outputPath = './docs/screenshots/category-navigation.png';
