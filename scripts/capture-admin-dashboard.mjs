...
async function captureScreenshot() {
  ...
  try {
    ...
    console.log('Loading admin dashboard demo HTML...');

    // Navigate to the demo HTML file
    const demoPath = 'file://' + process.cwd() + '/scripts/admin-dashboard-demo.html';
    ...
    // Save screenshot
    const outputPath = './docs/screenshots/admin-dashboard.png';
