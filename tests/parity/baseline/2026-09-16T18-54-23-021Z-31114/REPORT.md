...
Run: `2026-09-16T18-54-23-021Z-31114`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2142518067` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 0 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T18:54:00.000Z` on both sides.  
...
Selected run (`--only app.submit,app.admin.users,app.admin.github,app.admin.linkhealth --width 375,768,1024,1440`): 16 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.github | 375 | pixel | FAIL | 2067 | 0.5176% | 375×1065 vs 375×1065 | [actual](/actual/app.admin.github-375.png) · [expected](/expected/app.admin.github-375.png) · [diff](/diff/app.admin.github-375.png) — 0.518% differing pixels exceeds the 0.5% ceiling |
| app.admin.github | 768 | pixel | PASS | 2320 | 0.2950% | 768×1024 vs 768×1024 | [actual](/actual/app.admin.github-768.png) · [expected](/expected/app.admin.github-768.png) · [diff](/diff/app.admin.github-768.png) |
| app.admin.github | 1024 | pixel | FAIL | 5414 | 0.6029% | 1024×877 vs 1024×877 | [actual](/actual/app.admin.github-1024.png) · [expected](/expected/app.admin.github-1024.png) · [diff](/diff/app.admin.github-1024.png) — 0.603% differing pixels exceeds the 0.5% ceiling |
| app.admin.github | 1440 | pixel | PASS | 2606 | 0.2011% | 1440×900 vs 1440×900 | [actual](/actual/app.admin.github-1440.png) · [expected](/expected/app.admin.github-1440.png) · [diff](/diff/app.admin.github-1440.png) |
| app.admin.linkhealth | 375 | pixel | FAIL | 23269 | 5.4335% | 375×1142 vs 375×1087 | [actual](/actual/app.admin.linkhealth-375.png) · [expected](/expected/app.admin.linkhealth-375.png) · [diff](/diff/app.admin.linkhealth-375.png) — 5.434% differing pixels exceeds the 0.5% ceiling |
| app.admin.linkhealth | 768 | pixel | PASS | 3679 | 0.4678% | 768×1024 vs 768×1024 | [actual](/actual/app.admin.linkhealth-768.png) · [expected](/expected/app.admin.linkhealth-768.png) · [diff](/diff/app.admin.linkhealth-768.png) |
| app.admin.linkhealth | 1024 | pixel | PASS | 1748 | 0.2223% | 1024×768 vs 1024×768 | [actual](/actual/app.admin.linkhealth-1024.png) · [expected](/expected/app.admin.linkhealth-1024.png) · [diff](/diff/app.admin.linkhealth-1024.png) |
| app.admin.linkhealth | 1440 | pixel | PASS | 5519 | 0.4258% | 1440×900 vs 1440×900 | [actual](/actual/app.admin.linkhealth-1440.png) · [expected](/expected/app.admin.linkhealth-1440.png) · [diff](/diff/app.admin.linkhealth-1440.png) |
| app.admin.users | 375 | pixel | FAIL | 18090 | 4.0033% | 375×1205 vs 375×1165 | [actual](/actual/app.admin.users-375.png) · [expected](/expected/app.admin.users-375.png) · [diff](/diff/app.admin.users-375.png) — 4.003% differing pixels exceeds the 0.5% ceiling |
| app.admin.users | 768 | pixel | PASS | 4354 | 0.4947% | 768×1146 vs 768×1146 | [actual](/actual/app.admin.users-768.png) · [expected](/expected/app.admin.users-768.png) · [diff](/diff/app.admin.users-768.png) |
| app.admin.users | 1024 | pixel | FAIL | 9138 | 0.8656% | 1024×1031 vs 1024×1031 | [actual](/actual/app.admin.users-1024.png) · [expected](/expected/app.admin.users-1024.png) · [diff](/diff/app.admin.users-1024.png) — 0.866% differing pixels exceeds the 0.5% ceiling |
| app.admin.users | 1440 | pixel | PASS | 4253 | 0.3155% | 1440×936 vs 1440×936 | [actual](/actual/app.admin.users-1440.png) · [expected](/expected/app.admin.users-1440.png) · [diff](/diff/app.admin.users-1440.png) |
| app.submit | 375 | pixel | PASS | 4321 | 0.4758% | 375×2422 vs 375×2422 | [actual](/actual/app.submit-375.png) · [expected](/expected/app.submit-375.png) · [diff](/diff/app.submit-375.png) |
| app.submit | 768 | pixel | PASS | 4323 | 0.2918% | 768×1929 vs 768×1929 | [actual](/actual/app.submit-768.png) · [expected](/expected/app.submit-768.png) · [diff](/diff/app.submit-768.png) |
| app.submit | 1024 | pixel | PASS | 1049 | 0.0733% | 1024×1398 vs 1024×1398 | [actual](/actual/app.submit-1024.png) · [expected](/expected/app.submit-1024.png) · [diff](/diff/app.submit-1024.png) |
| app.submit | 1440 | pixel | PASS | 1204 | 0.0598% | 1440×1398 vs 1440×1398 | [actual](/actual/app.submit-1440.png) · [expected](/expected/app.submit-1440.png) · [diff](/diff/app.submit-1440.png) |
...
| admin.jsx | `            {[
            ...
            ].map((row, i) => (` | `            {[["resources","1,993","14 MB","37h ago"],["categories","9","96 KB","29d ago"],["subcategories","92","56 KB","29d ago"],["users","8","80 KB","0s ago"],["resource_audit_log","6,223","2.7 MB","2h ago"],["enrichment_jobs","26","168 KB","37h ago"]].map((row, i) => (` | /api/admin/stats database.tableStats (count(*), pg_total_relation_size, newest updated_at/created_at vs frozen clock; admin session only) |
...
| admin.jsx | `            {[
            ...
            ].map((row, i) => (` | `            {[{"k":"Database","v":"ready · 8ms","cls":"ok"},{"k":"GitHub sync","v":"failed · 119d ago","cls":"bad"},{"k":"Link checker","v":"no completed runs","cls":"muted"},{"k":"Enrichment queue","v":"5 failed","cls":"bad"},{"k":"Researcher API","v":"healthy","cls":"ok"}].map((row, i) => (` | /api/admin/operations/health, /api/health/ai, /api/github/sync-status|sync-history, /api/admin/link-health/status|history, /api/enrichment/jobs?limit=100 (AdminOverview.renderHealthRows mirror; admin session only) |
