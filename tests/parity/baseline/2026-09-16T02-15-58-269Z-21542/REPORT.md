...
Run: `2026-09-16T02-15-58-269Z-21542`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2121933806` "Nick" (torn down: local row deleted, Clerk user deleted, 3 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T02:15:00.000Z` on both sides.  
...
Selected run (`--only app.admin.approvals,app.admin.edits --width 1440`): 2 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.approvals | 1440 | pixel | FAIL | 22681 | 1.7501% | 1440×900 vs 1440×900 | [actual](/actual/app.admin.approvals-1440.png) · [expected](/expected/app.admin.approvals-1440.png) · [diff](/diff/app.admin.approvals-1440.png) — 1.750% differing pixels exceeds the 0.5% ceiling |
| app.admin.edits | 1440 | pixel | FAIL | 20215 | 1.5598% | 1440×900 vs 1440×900 | [actual](/actual/app.admin.edits-1440.png) · [expected](/expected/app.admin.edits-1440.png) · [diff](/diff/app.admin.edits-1440.png) — 1.560% differing pixels exceeds the 0.5% ceiling |
