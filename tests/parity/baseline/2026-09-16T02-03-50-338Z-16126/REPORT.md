...
Run: `2026-09-16T02-03-50-338Z-16126`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2040487258` "Nick" (torn down: local row deleted, Clerk user deleted, 0 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T02:03:00.000Z` on both sides.  
...
Selected run (`--only app.category,app.subcategory,app.subsubcategory --width 1440`): 3 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.category | 1440 | pixel | FAIL | 10412009 | 64.0383% | 1440×4239 vs 1440×11291 | [actual](/actual/app.category-1440.png) · [expected](/expected/app.category-1440.png) · [diff](/diff/app.category-1440.png) — 64.038% differing pixels exceeds the 0.5% ceiling |
| app.subcategory | 1440 | pixel | FAIL | 3184607 | 36.9760% | 1440×3968 vs 1440×5981 | [actual](/actual/app.subcategory-1440.png) · [expected](/expected/app.subcategory-1440.png) · [diff](/diff/app.subcategory-1440.png) — 36.976% differing pixels exceeds the 0.5% ceiling |
| app.subsubcategory | 1440 | pixel | FAIL | 3184735 | 36.9775% | 1440×3968 vs 1440×5981 | [actual](/actual/app.subsubcategory-1440.png) · [expected](/expected/app.subsubcategory-1440.png) · [diff](/diff/app.subsubcategory-1440.png) — 36.977% differing pixels exceeds the 0.5% ceiling; subsubcategory identity mismatch: app heading is "community groups", not the subsubcategory label |
