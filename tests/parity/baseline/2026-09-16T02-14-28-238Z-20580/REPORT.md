...
Run: `2026-09-16T02-14-28-238Z-20580`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 0)  
Identity: disposable Clerk admin `2072000419` "Nick" (torn down: local row deleted, Clerk user deleted, 3 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T02:14:00.000Z` on both sides.  
...
Selected run (`--only app.resource.detail --width 1440`): 1 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.resource.detail | 1440 | pixel | PASS | 9360 | 0.4862% | 1440×1337 vs 1440×1337 | [actual](/actual/app.resource.detail-1440.png) · [expected](/expected/app.resource.detail-1440.png) · [diff](/diff/app.resource.detail-1440.png) |
