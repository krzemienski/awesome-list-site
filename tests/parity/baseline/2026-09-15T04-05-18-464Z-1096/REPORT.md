...
Run: `2026-09-15T04-05-18-464Z-1096`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2000834183` "Nick" (torn down: local row deleted, Clerk user deleted, 1 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-15T04:05:00.000Z` on both sides.  
...
| app.admin.categories | 1440 | pixel | FAIL | 139773 | 8.4551% | 1440×1077 vs 1440×1148 | [actual](/actual/app.admin.categories-1440.png) · [expected](/expected/app.admin.categories-1440.png) · [diff](/diff/app.admin.categories-1440.png) — 8.455% differing pixels exceeds the 0.5% ceiling |
| app.admin.database | 1440 | pixel | FAIL | 300720 | 13.9408% | 1440×1326 vs 1440×1498 | [actual](/actual/app.admin.database-1440.png) · [expected](/expected/app.admin.database-1440.png) · [diff](/diff/app.admin.database-1440.png) — 13.941% differing pixels exceeds the 0.5% ceiling |
...
| app.admin.enrichment | 1440 | pixel | FAIL | 133883 | 6.0373% | 1440×1492 vs 1440×1540 | [actual](/actual/app.admin.enrichment-1440.png) · [expected](/expected/app.admin.enrichment-1440.png) · [diff](/diff/app.admin.enrichment-1440.png) — 6.037% differing pixels exceeds the 0.5% ceiling |
| app.admin.export | 1440 | pixel | FAIL | 276740 | 13.4675% | 1440×1283 vs 1440×1427 | [actual](/actual/app.admin.export-1440.png) · [expected](/expected/app.admin.export-1440.png) · [diff](/diff/app.admin.export-1440.png) — 13.467% differing pixels exceeds the 0.5% ceiling |
...
Catalog snapshot `9d2f503995d9ff87…` (9 categories, 1816 resources) bound to the design's `AV_*` globals; admin globals bound: AV_RETAINED_OPERATIONS, AV_RETAINED_CATALOG, AV_TOTAL_USERS, AV_USERS, AV_RECENT_ACTIVITY, AV_PENDING_APPROVALS, AV_PENDING_RESOURCES, AV_AUDIT_LOGS, AV_AUDIT_TOTAL, AV_CONTACT_SUBMISSIONS.
