...
Run: `2026-09-16T04-05-18-509Z-49511`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2010784172` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 5 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T04:05:00.000Z` on both sides.  
...
Selected run (`--only app.admin.subcategories,app.admin.resources,app.admin.database,app.admin.overview,app.category,app.about --width 1440`): 6 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.about | 1440 | pixel | FAIL | 60578 | 0.9981% | 1440×4215 vs 1440×4214 | [actual](/actual/app.about-1440.png) · [expected](/expected/app.about-1440.png) · [diff](/diff/app.about-1440.png) — 0.998% differing pixels exceeds the 0.5% ceiling |
| app.admin.database | 1440 | pixel | FAIL | 34193 | 1.8624% | 1440×1275 vs 1440×1259 | [actual](/actual/app.admin.database-1440.png) · [expected](/expected/app.admin.database-1440.png) · [diff](/diff/app.admin.database-1440.png) — 1.862% differing pixels exceeds the 0.5% ceiling |
| app.admin.overview | 1440 | pixel | FAIL | 17907 | 1.3817% | 1440×900 vs 1440×900 | [actual](/actual/app.admin.overview-1440.png) · [expected](/expected/app.admin.overview-1440.png) · [diff](/diff/app.admin.overview-1440.png) — 1.382% differing pixels exceeds the 0.5% ceiling |
| app.admin.resources | 1440 | pixel | FAIL | 101121 | 3.6216% | 1440×1939 vs 1440×1888 | [actual](/actual/app.admin.resources-1440.png) · [expected](/expected/app.admin.resources-1440.png) · [diff](/diff/app.admin.resources-1440.png) — 3.622% differing pixels exceeds the 0.5% ceiling |
| app.admin.subcategories | 1440 | pixel | FAIL | 210100 | 7.4440% | 1440×1960 vs 1440×1832 | [actual](/actual/app.admin.subcategories-1440.png) · [expected](/expected/app.admin.subcategories-1440.png) · [diff](/diff/app.admin.subcategories-1440.png) — 7.444% differing pixels exceeds the 0.5% ceiling |
| app.category | 1440 | pixel | FAIL | 392028 | 6.2931% | 1440×4326 vs 1440×4214 | [actual](/actual/app.category-1440.png) · [expected](/expected/app.category-1440.png) · [diff](/diff/app.category-1440.png) — 6.293% differing pixels exceeds the 0.5% ceiling |
...
| admin.jsx | `sub="2 admins · 1 contributor"` | `sub="5 admins · 7 contributors"` | /api/admin/users roles (admin session only) |
...
| admin.jsx | `            {[
            ...
            ].map((row, i) => (` | `            {[["resources","1,993","14 MB","22h ago"],["categories","9","96 KB","28d ago"],["subcategories","92","56 KB","28d ago"],["users","12","80 KB","0s ago"],["resource_audit_log","6,221","2.7 MB","3h ago"],["enrichment_jobs","26","168 KB","22h ago"]].map((row, i) => (` | /api/admin/stats database.tableStats (count(*), pg_total_relation_size, newest updated_at/created_at vs frozen clock; admin session only) |
