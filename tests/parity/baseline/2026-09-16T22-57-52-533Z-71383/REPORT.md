...
Run: `2026-09-16T22-57-52-533Z-71383`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2094045126` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 2 __qa_test_parity_ rows remaining)  
...
Selected run (`--only app.admin.researcher --width 375,768,1024`): 3 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
| app.admin.researcher | 1024 | pixel | FAIL | 6145 | 0.6123% | 1024×980 vs 1024×980 | [actual](/actual/app.admin.researcher-1024.png) · [expected](/expected/app.admin.researcher-1024.png) · [diff](/diff/app.admin.researcher-1024.png) — 0.612% differing pixels exceeds the 0.5% ceiling |
