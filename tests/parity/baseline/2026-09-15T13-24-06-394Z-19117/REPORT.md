...
Run: `2026-09-15T13-24-06-394Z-19117`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 0)  
Identity: disposable Clerk admin `2060235336` "Nick" (torn down: local row deleted, Clerk user deleted, 4 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-15T13:24:00.000Z` on both sides.  
...
| admin.jsx | `sub="2 admins · 1 contributor"` | `sub="8 admins · 4 contributors"` | /api/admin/users roles (admin session only) |
