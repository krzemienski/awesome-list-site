...
Run: `2026-09-16T02-09-21-116Z-18769`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2004201098` "Nick" (torn down: local row deleted, Clerk user deleted, 2 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T02:09:00.000Z` on both sides.  
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.resources | 1440 | pixel | FAIL | 254221 | 8.7571% | 1440×2016 vs 1440×1888 | [actual](/actual/app.admin.resources-1440.png) · [expected](/expected/app.admin.resources-1440.png) · [diff](/diff/app.admin.resources-1440.png) — 8.757% differing pixels exceeds the 0.5% ceiling |
