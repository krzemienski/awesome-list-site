...
Run: `2026-09-16T23-09-36-406Z-75220`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2117093758` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 2 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T23:09:00.000Z` on both sides.  
...
|---|---:|---|---|---:|---:|---|---|
| artifact.showcase | 375 | pixel | FAIL | 3039030 | 20.0629% | 741×20442 vs 741×20442 | [actual](/actual/artifact.showcase-375.png) · [expected](/expected/artifact.showcase-375.png) · [diff](/diff/artifact.showcase-375.png) — 20.063% differing pixels exceeds the 0.5% ceiling |
