...
Run: `2026-09-16T03-58-47-589Z-44240`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2046182682` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 3 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T03:58:00.000Z` on both sides.  
...
Selected run (`--only app.admin.enrichment,app.admin.researcher --width 1440`): 2 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.enrichment | 1440 | pixel | FAIL | 7366 | 0.5273% | 1440×970 vs 1440×970 | [actual](/actual/app.admin.enrichment-1440.png) · [expected](/expected/app.admin.enrichment-1440.png) · [diff](/diff/app.admin.enrichment-1440.png) — 0.527% differing pixels exceeds the 0.5% ceiling |
| app.admin.researcher | 1440 | pixel | PASS | 6914 | 0.4899% | 1440×980 vs 1440×980 | [actual](/actual/app.admin.researcher-1440.png) · [expected](/expected/app.admin.researcher-1440.png) · [diff](/diff/app.admin.researcher-1440.png) |
