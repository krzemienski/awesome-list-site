...
Run: `2026-09-16T03-50-13-193Z-37019`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2103369142` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 2 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T03:50:00.000Z` on both sides.  
...
Selected run (`--only app.admin.database,app.admin.export --width 375,768,1024,1440`): 8 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.database | 375 | pixel | FAIL | 18444 | 2.7694% | 375×1776 vs 375×1763 | [actual](/actual/app.admin.database-375.png) · [expected](/expected/app.admin.database-375.png) · [diff](/diff/app.admin.database-375.png) — 2.769% differing pixels exceeds the 0.5% ceiling |
| app.admin.database | 768 | pixel | FAIL | 22832 | 2.0892% | 768×1423 vs 768×1412 | [actual](/actual/app.admin.database-768.png) · [expected](/expected/app.admin.database-768.png) · [diff](/diff/app.admin.database-768.png) — 2.089% differing pixels exceeds the 0.5% ceiling |
| app.admin.database | 1024 | pixel | FAIL | 26798 | 2.0525% | 1024×1275 vs 1024×1259 | [actual](/actual/app.admin.database-1024.png) · [expected](/expected/app.admin.database-1024.png) · [diff](/diff/app.admin.database-1024.png) — 2.053% differing pixels exceeds the 0.5% ceiling |
| app.admin.database | 1440 | pixel | FAIL | 33465 | 1.8227% | 1440×1275 vs 1440×1259 | [actual](/actual/app.admin.database-1440.png) · [expected](/expected/app.admin.database-1440.png) · [diff](/diff/app.admin.database-1440.png) — 1.823% differing pixels exceeds the 0.5% ceiling |
| app.admin.export | 375 | pixel | FAIL | 5491 | 1.0211% | 375×1434 vs 375×1425 | [actual](/actual/app.admin.export-375.png) · [expected](/expected/app.admin.export-375.png) · [diff](/diff/app.admin.export-375.png) — 1.021% differing pixels exceeds the 0.5% ceiling |
| app.admin.export | 768 | pixel | PASS | 1264 | 0.1607% | 768×1024 vs 768×1024 | [actual](/actual/app.admin.export-768.png) · [expected](/expected/app.admin.export-768.png) · [diff](/diff/app.admin.export-768.png) |
| app.admin.export | 1024 | pixel | PASS | 1575 | 0.2003% | 1024×768 vs 1024×768 | [actual](/actual/app.admin.export-1024.png) · [expected](/expected/app.admin.export-1024.png) · [diff](/diff/app.admin.export-1024.png) |
| app.admin.export | 1440 | pixel | PASS | 1410 | 0.1088% | 1440×900 vs 1440×900 | [actual](/actual/app.admin.export-1440.png) · [expected](/expected/app.admin.export-1440.png) · [diff](/diff/app.admin.export-1440.png) |
