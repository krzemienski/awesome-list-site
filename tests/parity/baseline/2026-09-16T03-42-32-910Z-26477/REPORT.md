...
Run: `2026-09-16T03-42-32-910Z-26477`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2042809906` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 2 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T03:42:00.000Z` on both sides.  
...
Selected run (`--only app.admin.categories,app.admin.subcategories --width 1440`): 2 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.categories | 1440 | pixel | FAIL | 11938 | 0.8216% | 1440×1009 vs 1440×1009 | [actual](/actual/app.admin.categories-1440.png) · [expected](/expected/app.admin.categories-1440.png) · [diff](/diff/app.admin.categories-1440.png) — 0.822% differing pixels exceeds the 0.5% ceiling |
