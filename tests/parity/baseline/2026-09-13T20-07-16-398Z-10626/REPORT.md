...
Run: `2026-09-13T20-07-16-398Z-10626`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 0)  
Identity: disposable Clerk admin `2068556907` "Nick" (torn down: local row deleted, Clerk user deleted, 2 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-13T20:07:00.000Z` on both sides.  
...
Selected run (`--only app.home.index --width 375,768`): 2 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
