...
Run: `2026-09-16T03-54-29-034Z-40614`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2037820212` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 2 __qa_test_parity_ rows remaining)  
...
Selected run (`--only app.about --width 768`): 1 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.about | 768 | pixel | FAIL | 94963 | 2.4780% | 768×4974 vs 768×4990 | [actual](/actual/app.about-768.png) · [expected](/expected/app.about-768.png) · [diff](/diff/app.about-768.png) — 2.478% differing pixels exceeds the 0.5% ceiling |
