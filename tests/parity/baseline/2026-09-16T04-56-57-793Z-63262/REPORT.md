...
Run: `2026-09-16T04-56-57-793Z-63262`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2022224242` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 8 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T04:56:00.000Z` on both sides.  
...
Selected run (`--only app.admin.database --width 375,1440`): 2 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.database | 375 | pixel | FAIL | 19191 | 2.9028% | 375×1742 vs 375×1763 | [actual](/actual/app.admin.database-375.png) · [expected](/expected/app.admin.database-375.png) · [diff](/diff/app.admin.database-375.png) — 2.903% differing pixels exceeds the 0.5% ceiling |
