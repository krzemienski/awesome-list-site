...
Run: `2026-09-16T02-15-33-999Z-21378`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2091634536` "Nick" (torn down: local row deleted, Clerk user deleted, 3 __qa_test_parity_ rows remaining)  
...
Selected run (`--only app.admin.subcategories --width 1440`): 1 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.subcategories | 1440 | pixel | FAIL | 251266 | 8.9026% | 1440×1960 vs 1440×1832 | [actual](/actual/app.admin.subcategories-1440.png) · [expected](/expected/app.admin.subcategories-1440.png) · [diff](/diff/app.admin.subcategories-1440.png) — 8.903% differing pixels exceeds the 0.5% ceiling |
