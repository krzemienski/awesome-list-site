...
Run: `2026-09-16T03-54-40-149Z-40854`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2020282347` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 2 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T03:54:00.000Z` on both sides.  
...
Selected run (`--only app.admin.enrichment,app.admin.researcher,app.admin.linkhealth --width 1440`): 3 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.enrichment | 1440 | pixel | FAIL | 7669 | 0.5490% | 1440×970 vs 1440×970 | [actual](/actual/app.admin.enrichment-1440.png) · [expected](/expected/app.admin.enrichment-1440.png) · [diff](/diff/app.admin.enrichment-1440.png) — 0.549% differing pixels exceeds the 0.5% ceiling |
| app.admin.linkhealth | 1440 | pixel | FAIL | 12218 | 0.9427% | 1440×900 vs 1440×900 | [actual](/actual/app.admin.linkhealth-1440.png) · [expected](/expected/app.admin.linkhealth-1440.png) · [diff](/diff/app.admin.linkhealth-1440.png) — 0.943% differing pixels exceeds the 0.5% ceiling |
| app.admin.researcher | 1440 | pixel | FAIL | 7501 | 0.5315% | 1440×980 vs 1440×980 | [actual](/actual/app.admin.researcher-1440.png) · [expected](/expected/app.admin.researcher-1440.png) · [diff](/diff/app.admin.researcher-1440.png) — 0.532% differing pixels exceeds the 0.5% ceiling |
