...
Run: `2026-09-16T03-39-18-708Z-19898`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2030272749` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 1 __qa_test_parity_ rows remaining)  
...
|---|---:|---|---|---:|---:|---|---|
| app.about | 1440 | pixel | FAIL | 263225 | 4.3378% | 1440×4128 vs 1440×4214 | [actual](/actual/app.about-1440.png) · [expected](/expected/app.about-1440.png) · [diff](/diff/app.about-1440.png) — 4.338% differing pixels exceeds the 0.5% ceiling |
