...
Run: `2026-09-16T02-21-20-992Z-23635`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2001552596` "Nick" (torn down: local row deleted, Clerk user deleted, 4 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T02:21:00.000Z` on both sides.  
...
Selected run (`--only app.submit --width 1440`): 1 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
