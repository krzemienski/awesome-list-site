...
Run: `2026-09-16T07-08-57-394Z-332`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2019408979` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 8 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T07:08:00.000Z` on both sides.  
Denominator: 2 pass / 4 fail / **6** pixel rows executed. 0 row-incomplete, 0 blocked, 0 evidence-only, 0 token-only, 0 aliases, 0 not selected.

Selected run (`--only app.submit,app.admin.enrichment,app.admin.users --width 375,1440`): 6 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.enrichment | 375 | pixel | PASS | 580 | 0.1092% | 375×1416 vs 375×1416 | [actual](/actual/app.admin.enrichment-375.png) · [expected](/expected/app.admin.enrichment-375.png) · [diff](/diff/app.admin.enrichment-375.png) |
| app.admin.enrichment | 1440 | pixel | PASS | 802 | 0.0574% | 1440×970 vs 1440×970 | [actual](/actual/app.admin.enrichment-1440.png) · [expected](/expected/app.admin.enrichment-1440.png) · [diff](/diff/app.admin.enrichment-1440.png) |
...
| app.admin.users | 1440 | pixel | FAIL | 42714 | 2.1279% | 1440×1394 vs 1440×1384 | [actual](/actual/app.admin.users-1440.png) · [expected](/expected/app.admin.users-1440.png) · [diff](/diff/app.admin.users-1440.png) — 2.128% differing pixels exceeds the 0.5% ceiling |
| app.submit | 375 | pixel | FAIL | 50713 | 5.4684% | 375×2473 vs 375×2422 | [actual](/actual/app.submit-375.png) · [expected](/expected/app.submit-375.png) · [diff](/diff/app.submit-375.png) — 5.468% differing pixels exceeds the 0.5% ceiling |
| app.submit | 1440 | pixel | FAIL | 32159 | 1.5975% | 1440×1395 vs 1440×1398 | [actual](/actual/app.submit-1440.png) · [expected](/expected/app.submit-1440.png) · [diff](/diff/app.submit-1440.png) — 1.597% differing pixels exceeds the 0.5% ceiling |
