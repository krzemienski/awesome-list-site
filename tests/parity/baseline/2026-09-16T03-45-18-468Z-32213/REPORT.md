...
Run: `2026-09-16T03-45-18-468Z-32213`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2127900459` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 4 __qa_test_parity_ rows remaining)  
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.audit | 1440 | pixel | FAIL | 87432 | 1.8433% | 1440×3294 vs 1440×3278 | [actual](/actual/app.admin.audit-1440.png) · [expected](/expected/app.admin.audit-1440.png) · [diff](/diff/app.admin.audit-1440.png) — 1.843% differing pixels exceeds the 0.5% ceiling |
