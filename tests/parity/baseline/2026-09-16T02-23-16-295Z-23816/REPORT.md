...
Run: `2026-09-16T02-23-16-295Z-23816`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2098184461` "Nick" (torn down: local row deleted, Clerk user deleted, 4 __qa_test_parity_ rows remaining)  
...
Selected run (`--only app.subcategory --width 1440`): 1 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.subcategory | 1440 | pixel | FAIL | 400183 | 4.6441% | 1440×5984 vs 1440×5981 | [actual](/actual/app.subcategory-1440.png) · [expected](/expected/app.subcategory-1440.png) · [diff](/diff/app.subcategory-1440.png) — 4.644% differing pixels exceeds the 0.5% ceiling |
