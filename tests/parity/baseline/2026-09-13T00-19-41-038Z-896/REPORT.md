...
Run: `2026-09-13T00-19-41-038Z-896`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2070277790` "Nick" (torn down: local row deleted, Clerk user deleted, 1 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-13T00:19:00.000Z` on both sides.  
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.overview | 375 | pixel | FAIL | 165897 | 19.0686% | 375×2175 vs 400×1999 | [actual](/actual/app.admin.overview-375.png) · [expected](/expected/app.admin.overview-375.png) · [diff](/diff/app.admin.overview-375.png) — 19.069% differing pixels exceeds the 0.5% ceiling; backdrop-filter sets differ (app ["blur(14px)"] vs reference ["blur(14px)","blur(2px)"]) |
| app.admin.overview | 768 | pixel | FAIL | 194638 | 13.5744% | 768×1867 vs 768×1698 | [actual](/actual/app.admin.overview-768.png) · [expected](/expected/app.admin.overview-768.png) · [diff](/diff/app.admin.overview-768.png) — 13.574% differing pixels exceeds the 0.5% ceiling; backdrop-filter sets differ (app ["blur(14px)"] vs reference ["blur(14px)","blur(2px)"]) |
| app.admin.overview | 1024 | pixel | FAIL | 812605 | 41.9429% | 1024×1892 vs 1024×1157 | [actual](/actual/app.admin.overview-1024.png) · [expected](/expected/app.admin.overview-1024.png) · [diff](/diff/app.admin.overview-1024.png) — 41.943% differing pixels exceeds the 0.5% ceiling; backdrop-filter sets differ (app ["blur(14px)"] vs reference ["blur(14px)","blur(2px)"]) |
| app.admin.overview | 1440 | pixel | FAIL | 604466 | 32.8714% | 1440×1277 vs 1440×900 | [actual](/actual/app.admin.overview-1440.png) · [expected](/expected/app.admin.overview-1440.png) · [diff](/diff/app.admin.overview-1440.png) — 32.871% differing pixels exceeds the 0.5% ceiling; backdrop-filter sets differ (app ["blur(14px)"] vs reference ["blur(14px)","blur(2px)"]) |
