...
Run: `2026-09-16T03-48-00-286Z-34991`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2023035056` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 2 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T03:48:00.000Z` on both sides.  
...
Selected run (`--only app.admin.enrichment,app.admin.researcher,app.admin.github --width 1440`): 3 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.enrichment | 1440 | pixel | FAIL | 59194 | 4.1025% | 1440×1002 vs 1440×970 | [actual](/actual/app.admin.enrichment-1440.png) · [expected](/expected/app.admin.enrichment-1440.png) · [diff](/diff/app.admin.enrichment-1440.png) — 4.102% differing pixels exceeds the 0.5% ceiling |
| app.admin.github | 1440 | pixel | PASS | 4606 | 0.3554% | 1440×900 vs 1440×900 | [actual](/actual/app.admin.github-1440.png) · [expected](/expected/app.admin.github-1440.png) · [diff](/diff/app.admin.github-1440.png) |
| app.admin.researcher | 1440 | pixel | FAIL | 13692 | 0.9673% | 1440×983 vs 1440×980 | [actual](/actual/app.admin.researcher-1440.png) · [expected](/expected/app.admin.researcher-1440.png) · [diff](/diff/app.admin.researcher-1440.png) — 0.967% differing pixels exceeds the 0.5% ceiling |
