...
Run: `2026-09-16T03-39-25-909Z-20272`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2069244373` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 1 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T03:39:00.000Z` on both sides.  
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.categories | 1440 | pixel | FAIL | 20229 | 1.3923% | 1440×1004 vs 1440×1009 | [actual](/actual/app.admin.categories-1440.png) · [expected](/expected/app.admin.categories-1440.png) · [diff](/diff/app.admin.categories-1440.png) — 1.392% differing pixels exceeds the 0.5% ceiling |
