...
Run: `2026-09-16T02-09-37-360Z-18960`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2114414148` "Nick" (torn down: local row deleted, Clerk user deleted, 2 __qa_test_parity_ rows remaining)  
...
|---|---:|---|---|---:|---:|---|---|
| app.subcategory | 1440 | pixel | FAIL | 3177073 | 36.8885% | 1440×3968 vs 1440×5981 | [actual](/actual/app.subcategory-1440.png) · [expected](/expected/app.subcategory-1440.png) · [diff](/diff/app.subcategory-1440.png) — 36.888% differing pixels exceeds the 0.5% ceiling |
