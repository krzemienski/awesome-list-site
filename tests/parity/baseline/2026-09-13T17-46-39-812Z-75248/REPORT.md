...
Run: `2026-09-13T17-46-39-812Z-75248`  
Claim: **visitor-evidence-only**  
Gate: **NOT PASSED** (exit code 0)  
Identity: visitor (`--as visitor`, --as visitor)  
Frozen clock: `2026-09-13T17:46:00.000Z` on both sides.  
Denominator: 0 pass / 0 fail / **0** pixel rows executed. 0 row-incomplete, 0 blocked, 8 evidence-only, 0 token-only, 0 aliases, 0 not selected.

Selected run (`--only app.shell.palette,app.shell.mobile-drawer --width 375,768,1024,1440`): 8 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.shell.mobile-drawer | 375 | pixel | EVIDENCE (visitor-identity) | 12889 | 0.5589% | 375×6149 vs 375×6150 | [actual](/actual/app.shell.mobile-drawer-375.png) · [expected](/expected/app.shell.mobile-drawer-375.png) · [diff](/diff/app.shell.mobile-drawer-375.png) — 0.559% differing pixels exceeds the 0.5% ceiling |
| app.shell.mobile-drawer | 768 | pixel | EVIDENCE (visitor-identity) | 12178 | 0.3694% | 768×4292 vs 768×4292 | [actual](/actual/app.shell.mobile-drawer-768.png) · [expected](/expected/app.shell.mobile-drawer-768.png) · [diff](/diff/app.shell.mobile-drawer-768.png) |
| app.shell.mobile-drawer | 1024 | pixel | EVIDENCE (visitor-identity) | 11314 | 0.2946% | 1024×3751 vs 1024×3751 | [actual](/actual/app.shell.mobile-drawer-1024.png) · [expected](/expected/app.shell.mobile-drawer-1024.png) · [diff](/diff/app.shell.mobile-drawer-1024.png) |
| app.shell.mobile-drawer | 1440 | pixel | EVIDENCE (visitor-identity) | 9345 | 0.2034% | 1440×3190 vs 1440×3190 | [actual](/actual/app.shell.mobile-drawer-1440.png) · [expected](/expected/app.shell.mobile-drawer-1440.png) · [diff](/diff/app.shell.mobile-drawer-1440.png) |
| app.shell.palette | 375 | pixel | EVIDENCE (visitor-identity) | 13165 | 0.5708% | 375×6149 vs 375×6150 | [actual](/actual/app.shell.palette-375.png) · [expected](/expected/app.shell.palette-375.png) · [diff](/diff/app.shell.palette-375.png) — 0.571% differing pixels exceeds the 0.5% ceiling |
| app.shell.palette | 768 | pixel | EVIDENCE (visitor-identity) | 14935 | 0.4531% | 768×4292 vs 768×4292 | [actual](/actual/app.shell.palette-768.png) · [expected](/expected/app.shell.palette-768.png) · [diff](/diff/app.shell.palette-768.png) |
| app.shell.palette | 1024 | pixel | EVIDENCE (visitor-identity) | 18264 | 0.4755% | 1024×3751 vs 1024×3751 | [actual](/actual/app.shell.palette-1024.png) · [expected](/expected/app.shell.palette-1024.png) · [diff](/diff/app.shell.palette-1024.png) |
| app.shell.palette | 1440 | pixel | EVIDENCE (visitor-identity) | 19792 | 0.4309% | 1440×3190 vs 1440×3190 | [actual](/actual/app.shell.palette-1440.png) · [expected](/expected/app.shell.palette-1440.png) · [diff](/diff/app.shell.palette-1440.png) |
...
Catalog snapshot `b6d0b9c700997e4f…` (9 categories, 1817 resources) bound to the design's `AV_*` globals; admin globals bound: none (no admin session).
...
Determinism proof (standalone `--determinism 2` run `2026-09-13T17-16-34-952Z-70048`, reference side): 4 row/width cells captured 2 times each in fresh contexts — all 4 cells byte-identical (see [determinism.json](../../../../docs/parity/evidence/harness/determinism/determinism.json)).
