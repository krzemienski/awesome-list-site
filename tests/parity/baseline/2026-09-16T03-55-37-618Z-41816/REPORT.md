...
Run: `2026-09-16T03-55-37-618Z-41816`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2126306938` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 2 __qa_test_parity_ rows remaining)  
...
| app.admin.users | 1440 | pixel | FAIL | 9657 | 0.6399% | 1440×1047 vs 1440×1048 | [actual](/actual/app.admin.users-1440.png) · [expected](/expected/app.admin.users-1440.png) · [diff](/diff/app.admin.users-1440.png) — 0.640% differing pixels exceeds the 0.5% ceiling |
