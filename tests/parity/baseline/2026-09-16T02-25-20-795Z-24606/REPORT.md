...
Run: `2026-09-16T02-25-20-795Z-24606`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2024909301` "Nick" (torn down: local row deleted, Clerk user deleted, 4 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T02:25:00.000Z` on both sides.  
...
Selected run (`--only app.admin.database --width 1440`): 1 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.database | 1440 | pixel | FAIL | 124924 | 6.8906% | 1440×1196 vs 1440×1259 | [actual](/actual/app.admin.database-1440.png) · [expected](/expected/app.admin.database-1440.png) · [diff](/diff/app.admin.database-1440.png) — 6.891% differing pixels exceeds the 0.5% ceiling |
