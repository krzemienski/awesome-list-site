...
Run: `2026-09-16T02-12-34-289Z-20119`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2099315370` "Nick" (torn down: local row deleted, Clerk user deleted, 2 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T02:12:00.000Z` on both sides.  
...
Selected run (`--only app.admin.categories --width 1440`): 1 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.categories | 1440 | pixel | FAIL | 72957 | 4.8857% | 1440×1037 vs 1440×1009 | [actual](/actual/app.admin.categories-1440.png) · [expected](/expected/app.admin.categories-1440.png) · [diff](/diff/app.admin.categories-1440.png) — 4.886% differing pixels exceeds the 0.5% ceiling |
