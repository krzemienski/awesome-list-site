...
Run: `2026-09-16T17-48-42-424Z-12729`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 0)  
Identity: disposable Clerk admin `2076982906` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 0 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T17:48:00.000Z` on both sides.  
...
|---|---:|---|---|---:|---:|---|---|
| app.category | 375 | pixel | PASS | 3068 | 0.0721% | 375×11351 vs 375×11352 | [actual](/actual/app.category-375.png) · [expected](/expected/app.category-375.png) · [diff](/diff/app.category-375.png) |
| app.category | 768 | pixel | PASS | 2007 | 0.0417% | 768×6265 vs 768×6266 | [actual](/actual/app.category-768.png) · [expected](/expected/app.category-768.png) · [diff](/diff/app.category-768.png) |
| app.category | 1024 | pixel | PASS | 8042 | 0.1373% | 1024×5718 vs 1024×5718 | [actual](/actual/app.category-1024.png) · [expected](/expected/app.category-1024.png) · [diff](/diff/app.category-1024.png) |
| app.category | 1440 | pixel | PASS | 9431 | 0.1520% | 1440×4310 vs 1440×4310 | [actual](/actual/app.category-1440.png) · [expected](/expected/app.category-1440.png) · [diff](/diff/app.category-1440.png) |
| app.subcategory | 375 | pixel | PASS | 4705 | 0.1159% | 375×10823 vs 375×10824 | [actual](/actual/app.subcategory-375.png) · [expected](/expected/app.subcategory-375.png) · [diff](/diff/app.subcategory-375.png) |
| app.subcategory | 768 | pixel | PASS | 5263 | 0.1162% | 768×5899 vs 768×5900 | [actual](/actual/app.subcategory-768.png) · [expected](/expected/app.subcategory-768.png) · [diff](/diff/app.subcategory-768.png) |
| app.subcategory | 1024 | pixel | PASS | 7906 | 0.1443% | 1024×5352 vs 1024×5352 | [actual](/actual/app.subcategory-1024.png) · [expected](/expected/app.subcategory-1024.png) · [diff](/diff/app.subcategory-1024.png) |
| app.subcategory | 1440 | pixel | PASS | 9989 | 0.1760% | 1440×3941 vs 1440×3941 | [actual](/actual/app.subcategory-1440.png) · [expected](/expected/app.subcategory-1440.png) · [diff](/diff/app.subcategory-1440.png) |
...
| admin.jsx | `            {[
            ...
            ].map((row, i) => (` | `            {[["resources","1,993","14 MB","36h ago"],["categories","9","96 KB","29d ago"],["subcategories","92","56 KB","29d ago"],["users","8","80 KB","0s ago"],["resource_audit_log","6,223","2.7 MB","32m ago"],["enrichment_jobs","26","168 KB","36h ago"]].map((row, i) => (` | /api/admin/stats database.tableStats (count(*), pg_total_relation_size, newest updated_at/created_at vs frozen clock; admin session only) |
