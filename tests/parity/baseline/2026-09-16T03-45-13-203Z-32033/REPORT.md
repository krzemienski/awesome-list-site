...
Run: `2026-09-16T03-45-13-203Z-32033`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2080882284` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 2 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T03:45:00.000Z` on both sides.  
...
Selected run (`--only app.admin.users,app.admin.resources,app.admin.approvals --width 1440`): 3 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.approvals | 1440 | pixel | PASS | 789 | 0.0609% | 1440×900 vs 1440×900 | [actual](/actual/app.admin.approvals-1440.png) · [expected](/expected/app.admin.approvals-1440.png) · [diff](/diff/app.admin.approvals-1440.png) |
| app.admin.resources | 1440 | pixel | FAIL | 48639 | 1.7890% | 1440×1888 vs 1440×1888 | [actual](/actual/app.admin.resources-1440.png) · [expected](/expected/app.admin.resources-1440.png) · [diff](/diff/app.admin.resources-1440.png) — 1.789% differing pixels exceeds the 0.5% ceiling |
| app.admin.users | 1440 | pixel | FAIL | 17196 | 1.1395% | 1440×1047 vs 1440×1048 | [actual](/actual/app.admin.users-1440.png) · [expected](/expected/app.admin.users-1440.png) · [diff](/diff/app.admin.users-1440.png) — 1.139% differing pixels exceeds the 0.5% ceiling |
