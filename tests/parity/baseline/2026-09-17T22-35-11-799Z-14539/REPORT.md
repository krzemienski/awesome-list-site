...
Run: `2026-09-17T22-35-11-799Z-14539`  
Claim: **visitor-evidence-only**  
Gate: **NOT PASSED** (exit code 1)  
Identity: visitor (`--as visitor`, --as visitor)  
Frozen clock: `2026-09-17T22:35:00.000Z` on both sides.  
Denominator: 0 pass / 6 fail / **6** pixel rows executed. 0 row-incomplete, 0 blocked, 2 evidence-only, 0 token-only, 0 aliases, 0 not selected.

Selected run (`--only app.category,artifact.showcase,artifact.docs.typography,artifact.docs.forms --width 375,768`): 8 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.category | 375 | pixel | EVIDENCE (visitor-identity) | 250244 | 5.8743% | 375×11355 vs 375×11360 | [actual](/actual/app.category-375.png) · [expected](/expected/app.category-375.png) · [diff](/diff/app.category-375.png) — 5.874% differing pixels exceeds the 0.5% ceiling |
| app.category | 768 | pixel | EVIDENCE (visitor-identity) | 481149 | 6.9766% | 768×8980 vs 768×8716 | [actual](/actual/app.category-768.png) · [expected](/expected/app.category-768.png) · [diff](/diff/app.category-768.png) — 6.977% differing pixels exceeds the 0.5% ceiling |
| artifact.docs.forms | 375 | pixel | FAIL | 109058 | 9.2236% | 375×2974 vs 375×3153 | [actual](/actual/artifact.docs.forms-375.png) · [expected](/expected/artifact.docs.forms-375.png) · [diff](/diff/artifact.docs.forms-375.png) — 9.224% differing pixels exceeds the 0.5% ceiling |
| artifact.docs.forms | 768 | pixel | FAIL | 274168 | 13.1005% | 768×2725 vs 768×2429 | [actual](/actual/artifact.docs.forms-768.png) · [expected](/expected/artifact.docs.forms-768.png) · [diff](/diff/artifact.docs.forms-768.png) — 13.101% differing pixels exceeds the 0.5% ceiling |
| artifact.docs.typography | 375 | pixel | FAIL | 147168 | 9.0509% | 375×4163 vs 375×4336 | [actual](/actual/artifact.docs.typography-375.png) · [expected](/expected/artifact.docs.typography-375.png) · [diff](/diff/artifact.docs.typography-375.png) — 9.051% differing pixels exceeds the 0.5% ceiling |
| artifact.docs.typography | 768 | pixel | FAIL | 309619 | 11.6991% | 768×3446 vs 768×3150 | [actual](/actual/artifact.docs.typography-768.png) · [expected](/expected/artifact.docs.typography-768.png) · [diff](/diff/artifact.docs.typography-768.png) — 11.699% differing pixels exceeds the 0.5% ceiling |
| artifact.showcase | 375 | pixel | FAIL | 4577757 | 44.8428% | 375×18899 vs 457×22338 | [actual](/actual/artifact.showcase-375.png) · [expected](/expected/artifact.showcase-375.png) · [diff](/diff/artifact.showcase-375.png) — 44.843% differing pixels exceeds the 0.5% ceiling |
| artifact.showcase | 768 | pixel | FAIL | 611832 | 6.1828% | 768×12885 vs 768×12768 | [actual](/actual/artifact.showcase-768.png) · [expected](/expected/artifact.showcase-768.png) · [diff](/diff/artifact.showcase-768.png) — 6.183% differing pixels exceeds the 0.5% ceiling |
