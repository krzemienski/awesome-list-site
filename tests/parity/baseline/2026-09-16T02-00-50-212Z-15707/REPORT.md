...
Run: `2026-09-16T02-00-50-212Z-15707`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2052359767` "Nick" (torn down: local row deleted, Clerk user deleted, 0 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T02:00:00.000Z` on both sides.  
...
Selected run (`--only app.admin.audit --width 1440`): 1 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.audit | 1440 | pixel | FAIL | 633462 | 13.4199% | 1440×2909 vs 1440×3278 | [actual](/actual/app.admin.audit-1440.png) · [expected](/expected/app.admin.audit-1440.png) · [diff](/diff/app.admin.audit-1440.png) — 13.420% differing pixels exceeds the 0.5% ceiling |
