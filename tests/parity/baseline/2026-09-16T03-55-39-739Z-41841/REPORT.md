...
Run: `2026-09-16T03-55-39-739Z-41841`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2130126143` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 2 __qa_test_parity_ rows remaining)  
...
Selected run (`--only app.about --width 1024`): 1 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.about | 1024 | pixel | FAIL | 102095 | 2.3665% | 1024×4197 vs 1024×4213 | [actual](/actual/app.about-1024.png) · [expected](/expected/app.about-1024.png) · [diff](/diff/app.about-1024.png) — 2.367% differing pixels exceeds the 0.5% ceiling |
