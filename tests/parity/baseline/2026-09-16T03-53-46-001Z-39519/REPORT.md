...
Run: `2026-09-16T03-53-46-001Z-39519`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2022612768` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 2 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T03:53:00.000Z` on both sides.  
...
Selected run (`--only app.about --width 375`): 1 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.about | 375 | pixel | FAIL | 156933 | 5.2090% | 375×7972 vs 375×8034 | [actual](/actual/app.about-375.png) · [expected](/expected/app.about-375.png) · [diff](/diff/app.about-375.png) — 5.209% differing pixels exceeds the 0.5% ceiling |
