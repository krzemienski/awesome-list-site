...
Run: `2026-09-16T05-27-02-455Z-945`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2082697446` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 8 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T05:27:00.000Z` on both sides.  
...
Selected run (`--only app.admin.audit --width 375,768`): 2 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.audit | 375 | pixel | FAIL | 10975 | 0.6623% | 375×4419 vs 375×4395 | [actual](/actual/app.admin.audit-375.png) · [expected](/expected/app.admin.audit-375.png) · [diff](/diff/app.admin.audit-375.png) — 0.662% differing pixels exceeds the 0.5% ceiling |
| app.admin.audit | 768 | pixel | FAIL | 53169 | 1.5820% | 768×4376 vs 768×4376 | [actual](/actual/app.admin.audit-768.png) · [expected](/expected/app.admin.audit-768.png) · [diff](/diff/app.admin.audit-768.png) — 1.582% differing pixels exceeds the 0.5% ceiling |
