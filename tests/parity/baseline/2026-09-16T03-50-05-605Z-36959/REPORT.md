...
Run: `2026-09-16T03-50-05-605Z-36959`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2131175363` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 2 __qa_test_parity_ rows remaining)  
...
Selected run (`--only app.admin.users,app.admin.resources --width 1440`): 2 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.resources | 1440 | pixel | FAIL | 99378 | 3.5610% | 1440×1938 vs 1440×1888 | [actual](/actual/app.admin.resources-1440.png) · [expected](/expected/app.admin.resources-1440.png) · [diff](/diff/app.admin.resources-1440.png) — 3.561% differing pixels exceeds the 0.5% ceiling |
| app.admin.users | 1440 | pixel | FAIL | 9859 | 0.6533% | 1440×1047 vs 1440×1048 | [actual](/actual/app.admin.users-1440.png) · [expected](/expected/app.admin.users-1440.png) · [diff](/diff/app.admin.users-1440.png) — 0.653% differing pixels exceeds the 0.5% ceiling |
