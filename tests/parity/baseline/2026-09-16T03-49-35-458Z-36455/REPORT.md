...
Run: `2026-09-16T03-49-35-458Z-36455`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2119845132` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 2 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T03:49:00.000Z` on both sides.  
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.enrichment | 1440 | pixel | FAIL | 46543 | 3.2549% | 1440×993 vs 1440×970 | [actual](/actual/app.admin.enrichment-1440.png) · [expected](/expected/app.admin.enrichment-1440.png) · [diff](/diff/app.admin.enrichment-1440.png) — 3.255% differing pixels exceeds the 0.5% ceiling |
| app.admin.researcher | 1440 | pixel | FAIL | 16357 | 1.1591% | 1440×975 vs 1440×980 | [actual](/actual/app.admin.researcher-1440.png) · [expected](/expected/app.admin.researcher-1440.png) · [diff](/diff/app.admin.researcher-1440.png) — 1.159% differing pixels exceeds the 0.5% ceiling |
