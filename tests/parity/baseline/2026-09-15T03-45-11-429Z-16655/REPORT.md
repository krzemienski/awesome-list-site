...
Run: `2026-09-15T03-45-11-429Z-16655`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2052066993` "Nick" (torn down: local row deleted, Clerk user deleted, 1 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-15T03:45:00.000Z` on both sides.  
Denominator: 0 pass / 9 fail / **9** pixel rows executed. 0 row-incomplete, 0 blocked, 0 evidence-only, 0 token-only, 0 aliases, 0 not selected.

Selected run (`--only app.about,app.admin.approvals,app.admin.audit,app.admin.categories,app.admin.database,app.admin.edits,app.admin.enrichment,app.admin.export,app.admin.github --width 1440`): 9 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
| app.admin.approvals | 1440 | pixel | FAIL | 20616 | 1.5907% | 1440×900 vs 1440×900 | [actual](/actual/app.admin.approvals-1440.png) · [expected](/expected/app.admin.approvals-1440.png) · [diff](/diff/app.admin.approvals-1440.png) — 1.591% differing pixels exceeds the 0.5% ceiling |
| app.admin.audit | 1440 | pixel | FAIL | 713792 | 14.2521% | 1440×3478 vs 1440×3062 | [actual](/actual/app.admin.audit-1440.png) · [expected](/expected/app.admin.audit-1440.png) · [diff](/diff/app.admin.audit-1440.png) — 14.252% differing pixels exceeds the 0.5% ceiling |
| app.admin.categories | 1440 | pixel | FAIL | 295806 | 16.3943% | 1440×1077 vs 1440×1253 | [actual](/actual/app.admin.categories-1440.png) · [expected](/expected/app.admin.categories-1440.png) · [diff](/diff/app.admin.categories-1440.png) — 16.394% differing pixels exceeds the 0.5% ceiling |
| app.admin.database | 1440 | pixel | FAIL | 325133 | 14.9034% | 1440×1326 vs 1440×1515 | [actual](/actual/app.admin.database-1440.png) · [expected](/expected/app.admin.database-1440.png) · [diff](/diff/app.admin.database-1440.png) — 14.903% differing pixels exceeds the 0.5% ceiling |
| app.admin.edits | 1440 | pixel | FAIL | 19997 | 1.5430% | 1440×900 vs 1440×900 | [actual](/actual/app.admin.edits-1440.png) · [expected](/expected/app.admin.edits-1440.png) · [diff](/diff/app.admin.edits-1440.png) — 1.543% differing pixels exceeds the 0.5% ceiling |
| app.admin.enrichment | 1440 | pixel | FAIL | 2101819 | 50.2097% | 1440×1492 vs 1440×2907 | [actual](/actual/app.admin.enrichment-1440.png) · [expected](/expected/app.admin.enrichment-1440.png) · [diff](/diff/app.admin.enrichment-1440.png) — 50.210% differing pixels exceeds the 0.5% ceiling |
| app.admin.export | 1440 | pixel | FAIL | 185663 | 9.4803% | 1440×1283 vs 1440×1360 | [actual](/actual/app.admin.export-1440.png) · [expected](/expected/app.admin.export-1440.png) · [diff](/diff/app.admin.export-1440.png) — 9.480% differing pixels exceeds the 0.5% ceiling |
| app.admin.github | 1440 | pixel | FAIL | 1111446 | 18.8713% | 1440×4090 vs 1440×3391 | [actual](/actual/app.admin.github-1440.png) · [expected](/expected/app.admin.github-1440.png) · [diff](/diff/app.admin.github-1440.png) — 18.871% differing pixels exceeds the 0.5% ceiling |
...
Catalog snapshot `fe783c23c982aaef…` (9 categories, 1816 resources) bound to the design's `AV_*` globals; admin globals bound: AV_RETAINED_OPERATIONS, AV_RETAINED_CATALOG, AV_TOTAL_USERS, AV_USERS, AV_RECENT_ACTIVITY, AV_PENDING_APPROVALS, AV_PENDING_RESOURCES, AV_AUDIT_LOGS, AV_AUDIT_TOTAL, AV_CONTACT_SUBMISSIONS.
