...
Run: `2026-09-16T17-37-04-747Z-11506`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2147475147` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 0 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T17:37:00.000Z` on both sides.  
...
Selected run (`--only app.category,app.subcategory --width 375,768,1024,1440`): 8 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.category | 375 | pixel | FAIL | 79114 | 1.8550% | 375×11373 vs 375×11204 | [actual](/actual/app.category-375.png) · [expected](/expected/app.category-375.png) · [diff](/diff/app.category-375.png) — 1.855% differing pixels exceeds the 0.5% ceiling |
| app.category | 768 | pixel | FAIL | 107230 | 2.2201% | 768×6289 vs 768×6170 | [actual](/actual/app.category-768.png) · [expected](/expected/app.category-768.png) · [diff](/diff/app.category-768.png) — 2.220% differing pixels exceeds the 0.5% ceiling |
| app.category | 1024 | pixel | FAIL | 153115 | 2.6041% | 1024×5742 vs 1024×5622 | [actual](/actual/app.category-1024.png) · [expected](/expected/app.category-1024.png) · [diff](/diff/app.category-1024.png) — 2.604% differing pixels exceeds the 0.5% ceiling |
| app.category | 1440 | pixel | FAIL | 204266 | 3.2730% | 1440×4334 vs 1440×4214 | [actual](/actual/app.category-1440.png) · [expected](/expected/app.category-1440.png) · [diff](/diff/app.category-1440.png) — 3.273% differing pixels exceeds the 0.5% ceiling |
| app.subcategory | 375 | pixel | FAIL | 60380 | 1.4916% | 375×10795 vs 375×10676 | [actual](/actual/app.subcategory-375.png) · [expected](/expected/app.subcategory-375.png) · [diff](/diff/app.subcategory-375.png) — 1.492% differing pixels exceeds the 0.5% ceiling |
| app.subcategory | 768 | pixel | FAIL | 89430 | 1.9740% | 768×5899 vs 768×5804 | [actual](/actual/app.subcategory-768.png) · [expected](/expected/app.subcategory-768.png) · [diff](/diff/app.subcategory-768.png) — 1.974% differing pixels exceeds the 0.5% ceiling |
| app.subcategory | 1024 | pixel | FAIL | 129220 | 2.3578% | 1024×5352 vs 1024×5256 | [actual](/actual/app.subcategory-1024.png) · [expected](/expected/app.subcategory-1024.png) · [diff](/diff/app.subcategory-1024.png) — 2.358% differing pixels exceeds the 0.5% ceiling |
| app.subcategory | 1440 | pixel | FAIL | 171180 | 3.0164% | 1440×3941 vs 1440×3845 | [actual](/actual/app.subcategory-1440.png) · [expected](/expected/app.subcategory-1440.png) · [diff](/diff/app.subcategory-1440.png) — 3.016% differing pixels exceeds the 0.5% ceiling |
...
| admin.jsx | `            {[
            ...
            ].map((row, i) => (` | `            {[["resources","1,993","14 MB","36h ago"],["categories","9","96 KB","29d ago"],["subcategories","92","56 KB","29d ago"],["users","8","80 KB","0s ago"],["resource_audit_log","6,223","2.7 MB","21m ago"],["enrichment_jobs","26","168 KB","36h ago"]].map((row, i) => (` | /api/admin/stats database.tableStats (count(*), pg_total_relation_size, newest updated_at/created_at vs frozen clock; admin session only) |
