...
Run: `2026-09-16T02-12-14-117Z-19973`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2129483862` "Nick" (torn down: local row deleted, Clerk user deleted, 2 __qa_test_parity_ rows remaining)  
...
|---|---:|---|---|---:|---:|---|---|
| app.resource.detail | 1440 | pixel | FAIL | — | — | — | capture failed: page.evaluate: Error: Images did not decode within 20s
    at eval (eval at evaluate (:303:30), <anonymous>:19:58)
