...
Run: `2026-09-16T03-46-25-437Z-34116`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2051019198` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 3 __qa_test_parity_ rows remaining)  
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.database | 375 | pixel | FAIL | 18351 | 2.7554% | 375×1776 vs 375×1763 | [actual](/actual/app.admin.database-375.png) · [expected](/expected/app.admin.database-375.png) · [diff](/diff/app.admin.database-375.png) — 2.755% differing pixels exceeds the 0.5% ceiling |
| app.admin.database | 1440 | pixel | FAIL | 45341 | 2.4580% | 1440×1281 vs 1440×1259 | [actual](/actual/app.admin.database-1440.png) · [expected](/expected/app.admin.database-1440.png) · [diff](/diff/app.admin.database-1440.png) — 2.458% differing pixels exceeds the 0.5% ceiling |
