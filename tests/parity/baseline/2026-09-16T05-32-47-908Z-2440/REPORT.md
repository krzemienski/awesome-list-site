...
Run: `2026-09-16T05-32-47-908Z-2440`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2140091665` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 8 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T05:32:00.000Z` on both sides.  
Denominator: 5 pass / 3 fail / **8** pixel rows executed. 0 row-incomplete, 0 blocked, 0 evidence-only, 0 token-only, 0 aliases, 0 not selected.

Selected run (`--only app.admin.overview,app.admin.audit,app.admin.linkhealth,app.admin.enrichment --width 375,1440`): 8 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.audit | 375 | pixel | PASS | 211 | 0.0128% | 375×4395 vs 375×4395 | [actual](/actual/app.admin.audit-375.png) · [expected](/expected/app.admin.audit-375.png) · [diff](/diff/app.admin.audit-375.png) |
| app.admin.audit | 1440 | pixel | PASS | 2745 | 0.0582% | 1440×3278 vs 1440×3278 | [actual](/actual/app.admin.audit-1440.png) · [expected](/expected/app.admin.audit-1440.png) · [diff](/diff/app.admin.audit-1440.png) |
| app.admin.enrichment | 375 | pixel | FAIL | 29258 | 5.5100% | 375×1361 vs 375×1416 | [actual](/actual/app.admin.enrichment-375.png) · [expected](/expected/app.admin.enrichment-375.png) · [diff](/diff/app.admin.enrichment-375.png) — 5.510% differing pixels exceeds the 0.5% ceiling |
| app.admin.enrichment | 1440 | pixel | PASS | 1603 | 0.1148% | 1440×970 vs 1440×970 | [actual](/actual/app.admin.enrichment-1440.png) · [expected](/expected/app.admin.enrichment-1440.png) · [diff](/diff/app.admin.enrichment-1440.png) |
| app.admin.linkhealth | 375 | pixel | FAIL | 20300 | 4.7906% | 375×1130 vs 375×1087 | [actual](/actual/app.admin.linkhealth-375.png) · [expected](/expected/app.admin.linkhealth-375.png) · [diff](/diff/app.admin.linkhealth-375.png) — 4.791% differing pixels exceeds the 0.5% ceiling |
| app.admin.linkhealth | 1440 | pixel | PASS | 4550 | 0.3511% | 1440×900 vs 1440×900 | [actual](/actual/app.admin.linkhealth-1440.png) · [expected](/expected/app.admin.linkhealth-1440.png) · [diff](/diff/app.admin.linkhealth-1440.png) |
| app.admin.overview | 375 | pixel | FAIL | 79372 | 9.7845% | 375×2028 vs 400×1999 | [actual](/actual/app.admin.overview-375.png) · [expected](/expected/app.admin.overview-375.png) · [diff](/diff/app.admin.overview-375.png) — 9.785% differing pixels exceeds the 0.5% ceiling |
| app.admin.overview | 1440 | pixel | PASS | 1030 | 0.0795% | 1440×900 vs 1440×900 | [actual](/actual/app.admin.overview-1440.png) · [expected](/expected/app.admin.overview-1440.png) · [diff](/diff/app.admin.overview-1440.png) |
