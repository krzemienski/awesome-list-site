...
Run: `2026-09-14T16-23-53-893Z-1807`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 0)  
Identity: disposable Clerk admin `2026256320` "Nick" (torn down: local row deleted, Clerk user deleted, 2 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-14T16:23:00.000Z` on both sides.  
...
| app.home.curated | 1024 | pixel | PASS | 7472 | 0.2197% | 1024×3322 vs 1024×3322 | [actual](/actual/app.home.curated-1024.png) · [expected](/expected/app.home.curated-1024.png) · [diff](/diff/app.home.curated-1024.png) |
| app.home.curated | 1440 | pixel | PASS | 7970 | 0.2037% | 1440×2717 vs 1440×2717 | [actual](/actual/app.home.curated-1440.png) · [expected](/expected/app.home.curated-1440.png) · [diff](/diff/app.home.curated-1440.png) |
...
| app.home.index | 1024 | pixel | PASS | 6677 | 0.1738% | 1024×3751 vs 1024×3751 | [actual](/actual/app.home.index-1024.png) · [expected](/expected/app.home.index-1024.png) · [diff](/diff/app.home.index-1024.png) |
| app.home.index | 1440 | pixel | PASS | 7364 | 0.1603% | 1440×3190 vs 1440×3190 | [actual](/actual/app.home.index-1440.png) · [expected](/expected/app.home.index-1440.png) · [diff](/diff/app.home.index-1440.png) |
| app.shell.mobile-drawer | 375 | pixel | PASS | 9631 | 0.4176% | 375×6149 vs 375×6150 | [actual](/actual/app.shell.mobile-drawer-375.png) · [expected](/expected/app.shell.mobile-drawer-375.png) · [diff](/diff/app.shell.mobile-drawer-375.png) |
| app.shell.mobile-drawer | 768 | pixel | PASS | 10189 | 0.3091% | 768×4292 vs 768×4292 | [actual](/actual/app.shell.mobile-drawer-768.png) · [expected](/expected/app.shell.mobile-drawer-768.png) · [diff](/diff/app.shell.mobile-drawer-768.png) |
| app.shell.mobile-drawer | 1024 | pixel | PASS | 9082 | 0.2364% | 1024×3751 vs 1024×3751 | [actual](/actual/app.shell.mobile-drawer-1024.png) · [expected](/expected/app.shell.mobile-drawer-1024.png) · [diff](/diff/app.shell.mobile-drawer-1024.png) |
| app.shell.mobile-drawer | 1440 | pixel | PASS | 7364 | 0.1603% | 1440×3190 vs 1440×3190 | [actual](/actual/app.shell.mobile-drawer-1440.png) · [expected](/expected/app.shell.mobile-drawer-1440.png) · [diff](/diff/app.shell.mobile-drawer-1440.png) |
| app.shell.palette | 375 | pixel | PASS | 9548 | 0.4140% | 375×6149 vs 375×6150 | [actual](/actual/app.shell.palette-375.png) · [expected](/expected/app.shell.palette-375.png) · [diff](/diff/app.shell.palette-375.png) |
| app.shell.palette | 768 | pixel | PASS | 12356 | 0.3748% | 768×4292 vs 768×4292 | [actual](/actual/app.shell.palette-768.png) · [expected](/expected/app.shell.palette-768.png) · [diff](/diff/app.shell.palette-768.png) |
| app.shell.palette | 1024 | pixel | PASS | 12233 | 0.3185% | 1024×3751 vs 1024×3751 | [actual](/actual/app.shell.palette-1024.png) · [expected](/expected/app.shell.palette-1024.png) · [diff](/diff/app.shell.palette-1024.png) |
| app.shell.palette | 1440 | pixel | PASS | 17250 | 0.3755% | 1440×3190 vs 1440×3190 | [actual](/actual/app.shell.palette-1440.png) · [expected](/expected/app.shell.palette-1440.png) · [diff](/diff/app.shell.palette-1440.png) |
...
Catalog snapshot `a91170d015bd2062…` (9 categories, 1817 resources) bound to the design's `AV_*` globals; admin globals bound: AV_TOTAL_USERS, AV_USERS, AV_RECENT_ACTIVITY.
