...
Run: `2026-09-16T05-23-57-088Z-414`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2078599491` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 8 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T05:23:00.000Z` on both sides.  
Denominator: 1 pass / 2 fail / **3** pixel rows executed. 0 row-incomplete, 0 blocked, 0 evidence-only, 0 token-only, 0 aliases, 0 not selected.

Selected run (`--only app.admin.audit --width 375,768,1024`): 3 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.audit | 375 | pixel | FAIL | 154425 | 9.3697% | 375×4071 vs 375×4395 | [actual](/actual/app.admin.audit-375.png) · [expected](/expected/app.admin.audit-375.png) · [diff](/diff/app.admin.audit-375.png) — 9.370% differing pixels exceeds the 0.5% ceiling |
| app.admin.audit | 768 | pixel | FAIL | 364347 | 10.8412% | 768×4029 vs 768×4376 | [actual](/actual/app.admin.audit-768.png) · [expected](/expected/app.admin.audit-768.png) · [diff](/diff/app.admin.audit-768.png) — 10.841% differing pixels exceeds the 0.5% ceiling |
| app.admin.audit | 1024 | pixel | PASS | 2695 | 0.0803% | 1024×3278 vs 1024×3278 | [actual](/actual/app.admin.audit-1024.png) · [expected](/expected/app.admin.audit-1024.png) · [diff](/diff/app.admin.audit-1024.png) |
