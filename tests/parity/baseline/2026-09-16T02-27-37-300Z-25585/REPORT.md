...
Run: `2026-09-16T02-27-37-300Z-25585`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2091269176` "Nick" (torn down: local row deleted, Clerk user deleted, 4 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T02:27:00.000Z` on both sides.  
...
Selected run (`--only app.admin.resources --width 1440`): 1 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.resources | 1440 | pixel | FAIL | 176452 | 6.2391% | 1440×1964 vs 1440×1888 | [actual](/actual/app.admin.resources-1440.png) · [expected](/expected/app.admin.resources-1440.png) · [diff](/diff/app.admin.resources-1440.png) — 6.239% differing pixels exceeds the 0.5% ceiling |
