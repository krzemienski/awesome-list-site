...
Run: `2026-09-16T02-19-45-256Z-22687`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2056521715` "Nick" (torn down: local row deleted, Clerk user deleted, 3 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T02:19:00.000Z` on both sides.  
...
Selected run (`--only app.admin.github --width 1440`): 1 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.github | 1440 | pixel | FAIL | 102925 | 7.5158% | 1440×951 vs 1440×900 | [actual](/actual/app.admin.github-1440.png) · [expected](/expected/app.admin.github-1440.png) · [diff](/diff/app.admin.github-1440.png) — 7.516% differing pixels exceeds the 0.5% ceiling |
