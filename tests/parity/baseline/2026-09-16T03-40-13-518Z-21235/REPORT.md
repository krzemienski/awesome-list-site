...
Run: `2026-09-16T03-40-13-518Z-21235`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2035643694` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 2 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T03:40:00.000Z` on both sides.  
...
Selected run (`--only app.admin.export --width 375,768,1024`): 3 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.export | 375 | pixel | FAIL | 4549 | 0.8459% | 375×1434 vs 375×1425 | [actual](/actual/app.admin.export-375.png) · [expected](/expected/app.admin.export-375.png) · [diff](/diff/app.admin.export-375.png) — 0.846% differing pixels exceeds the 0.5% ceiling |
