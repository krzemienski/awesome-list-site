...
Run: `2026-09-16T17-32-09-585Z-10969`  
Claim: **incomplete-evidence**  
Gate: **NOT PASSED** (exit code 2)  
Identity: disposable Clerk admin `2081820935` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 0 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T17:32:00.000Z` on both sides.  
Denominator: 0 pass / 3 fail / **3** pixel rows executed. 5 row-incomplete, 0 blocked, 0 evidence-only, 0 token-only, 0 aliases, 0 not selected.
...
| admin.jsx | `            {[
            ...
            ].map((row, i) => (` | `            {[["resources","1,993","14 MB","36h ago"],["categories","9","96 KB","29d ago"],["subcategories","92","56 KB","29d ago"],["users","8","80 KB","0s ago"],["resource_audit_log","6,223","2.7 MB","16m ago"],["enrichment_jobs","26","168 KB","36h ago"]].map((row, i) => (` | /api/admin/stats database.tableStats (count(*), pg_total_relation_size, newest updated_at/created_at vs frozen clock; admin session only) |
