...
Run: `2026-09-16T05-43-30-334Z-4294`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2145812615` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 8 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T05:43:00.000Z` on both sides.  
...
Selected run (`--only app.admin.enrichment,app.admin.github,app.admin.researcher --width 375,1440`): 6 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
| app.admin.github | 375 | pixel | FAIL | 10802 | 2.7047% | 375×1065 vs 375×1065 | [actual](/actual/app.admin.github-375.png) · [expected](/expected/app.admin.github-375.png) · [diff](/diff/app.admin.github-375.png) — 2.705% differing pixels exceeds the 0.5% ceiling |
| app.admin.github | 1440 | pixel | FAIL | 7112 | 0.5488% | 1440×900 vs 1440×900 | [actual](/actual/app.admin.github-1440.png) · [expected](/expected/app.admin.github-1440.png) · [diff](/diff/app.admin.github-1440.png) — 0.549% differing pixels exceeds the 0.5% ceiling |
...
| app.admin.researcher | 1440 | pixel | PASS | 6910 | 0.4897% | 1440×980 vs 1440×980 | [actual](/actual/app.admin.researcher-1440.png) · [expected](/expected/app.admin.researcher-1440.png) · [diff](/diff/app.admin.researcher-1440.png) |
