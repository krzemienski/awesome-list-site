...
Run: `2026-09-15T13-14-18-043Z-17515`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 0)  
Identity: disposable Clerk admin `2004828978` "Nick" (torn down: local row deleted, Clerk user deleted, 2 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-15T13:14:00.000Z` on both sides.  
...
Selected run (`--only app.home.index,app.home.curated --width 375`): 2 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
