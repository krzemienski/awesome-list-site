...
|---|---:|---|---|---:|---:|---|---|
| app.about | 375 | pixel | FAIL | 155728 | 5.3343% | 375×7731 vs 375×7785 | [actual](/actual/app.about-375.png) · [expected](/expected/app.about-375.png) · [diff](/diff/app.about-375.png) — 5.334% differing pixels exceeds the 0.5% ceiling |
| app.about | 768 | pixel | FAIL | 200184 | 5.2446% | 768×4970 vs 768×4894 | [actual](/actual/app.about-768.png) · [expected](/expected/app.about-768.png) · [diff](/diff/app.about-768.png) — 5.245% differing pixels exceeds the 0.5% ceiling |
| app.about | 1024 | pixel | FAIL | 246072 | 5.7297% | 1024×4194 vs 1024×4099 | [actual](/actual/app.about-1024.png) · [expected](/expected/app.about-1024.png) · [diff](/diff/app.about-1024.png) — 5.730% differing pixels exceeds the 0.5% ceiling |
| app.about | 1440 | pixel | FAIL | 289379 | 4.7904% | 1440×4195 vs 1440×4100 | [actual](/actual/app.about-1440.png) · [expected](/expected/app.about-1440.png) · [diff](/diff/app.about-1440.png) — 4.790% differing pixels exceeds the 0.5% ceiling |
| app.admin.approvals | 375 | pixel | FAIL | 44795 | 13.7619% | 375×868 vs 375×812 | [actual](/actual/app.admin.approvals-375.png) · [expected](/expected/app.admin.approvals-375.png) · [diff](/diff/app.admin.approvals-375.png) — 13.762% differing pixels exceeds the 0.5% ceiling |
| app.admin.approvals | 768 | pixel | FAIL | 23610 | 3.0022% | 768×1024 vs 768×1024 | [actual](/actual/app.admin.approvals-768.png) · [expected](/expected/app.admin.approvals-768.png) · [diff](/diff/app.admin.approvals-768.png) — 3.002% differing pixels exceeds the 0.5% ceiling |
| app.admin.approvals | 1024 | pixel | FAIL | 46000 | 5.7080% | 1024×787 vs 1024×768 | [actual](/actual/app.admin.approvals-1024.png) · [expected](/expected/app.admin.approvals-1024.png) · [diff](/diff/app.admin.approvals-1024.png) — 5.708% differing pixels exceeds the 0.5% ceiling |
| app.admin.approvals | 1440 | pixel | FAIL | 27336 | 2.1093% | 1440×900 vs 1440×900 | [actual](/actual/app.admin.approvals-1440.png) · [expected](/expected/app.admin.approvals-1440.png) · [diff](/diff/app.admin.approvals-1440.png) — 2.109% differing pixels exceeds the 0.5% ceiling |
| app.admin.audit | 375 | pixel | FAIL | 668901 | 36.9916% | 375×4822 vs 375×3162 | [actual](/actual/app.admin.audit-375.png) · [expected](/expected/app.admin.audit-375.png) · [diff](/diff/app.admin.audit-375.png) — 36.992% differing pixels exceeds the 0.5% ceiling |
| app.admin.audit | 768 | pixel | FAIL | 1231765 | 35.2342% | 768×4552 vs 768×3060 | [actual](/actual/app.admin.audit-768.png) · [expected](/expected/app.admin.audit-768.png) · [diff](/diff/app.admin.audit-768.png) — 35.234% differing pixels exceeds the 0.5% ceiling |
| app.admin.audit | 1024 | pixel | FAIL | 1629505 | 35.2216% | 1024×4518 vs 1024×3022 | [actual](/actual/app.admin.audit-1024.png) · [expected](/expected/app.admin.audit-1024.png) · [diff](/diff/app.admin.audit-1024.png) — 35.222% differing pixels exceeds the 0.5% ceiling |
| app.admin.audit | 1440 | pixel | FAIL | 2255320 | 34.6657% | 1440×4518 vs 1440×3022 | [actual](/actual/app.admin.audit-1440.png) · [expected](/expected/app.admin.audit-1440.png) · [diff](/diff/app.admin.audit-1440.png) — 34.666% differing pixels exceeds the 0.5% ceiling |
| app.admin.categories | 375 | pixel | FAIL | 62640 | 13.0909% | 375×1276 vs 375×1216 | [actual](/actual/app.admin.categories-375.png) · [expected](/expected/app.admin.categories-375.png) · [diff](/diff/app.admin.categories-375.png) — 13.091% differing pixels exceeds the 0.5% ceiling |
| app.admin.categories | 768 | pixel | FAIL | 139123 | 14.9834% | 768×1209 vs 768×1086 | [actual](/actual/app.admin.categories-768.png) · [expected](/expected/app.admin.categories-768.png) · [diff](/diff/app.admin.categories-768.png) — 14.983% differing pixels exceeds the 0.5% ceiling |
| app.admin.categories | 1024 | pixel | FAIL | 116560 | 10.5690% | 1024×1077 vs 1024×1009 | [actual](/actual/app.admin.categories-1024.png) · [expected](/expected/app.admin.categories-1024.png) · [diff](/diff/app.admin.categories-1024.png) — 10.569% differing pixels exceeds the 0.5% ceiling |
| app.admin.categories | 1440 | pixel | FAIL | 145752 | 9.3980% | 1440×1077 vs 1440×1009 | [actual](/actual/app.admin.categories-1440.png) · [expected](/expected/app.admin.categories-1440.png) · [diff](/diff/app.admin.categories-1440.png) — 9.398% differing pixels exceeds the 0.5% ceiling |
| app.admin.database | 375 | pixel | FAIL | 216236 | 26.0800% | 375×2211 vs 375×1763 | [actual](/actual/app.admin.database-375.png) · [expected](/expected/app.admin.database-375.png) · [diff](/diff/app.admin.database-375.png) — 26.080% differing pixels exceeds the 0.5% ceiling |
| app.admin.database | 768 | pixel | FAIL | 418225 | 28.8282% | 768×1889 vs 768×1412 | [actual](/actual/app.admin.database-768.png) · [expected](/expected/app.admin.database-768.png) · [diff](/diff/app.admin.database-768.png) — 28.828% differing pixels exceeds the 0.5% ceiling |
| app.admin.database | 1024 | pixel | FAIL | 290300 | 19.0522% | 1024×1488 vs 1024×1259 | [actual](/actual/app.admin.database-1024.png) · [expected](/expected/app.admin.database-1024.png) · [diff](/diff/app.admin.database-1024.png) — 19.052% differing pixels exceeds the 0.5% ceiling |
| app.admin.database | 1440 | pixel | FAIL | 179718 | 9.2929% | 1440×1343 vs 1440×1259 | [actual](/actual/app.admin.database-1440.png) · [expected](/expected/app.admin.database-1440.png) · [diff](/diff/app.admin.database-1440.png) — 9.293% differing pixels exceeds the 0.5% ceiling |
...
| app.admin.edits | 375 | pixel | FAIL | 35140 | 11.1291% | 375×842 vs 375×812 | [actual](/actual/app.admin.edits-375.png) · [expected](/expected/app.admin.edits-375.png) · [diff](/diff/app.admin.edits-375.png) — 11.129% differing pixels exceeds the 0.5% ceiling |
| app.admin.edits | 768 | pixel | FAIL | 24019 | 3.0542% | 768×1024 vs 768×1024 | [actual](/actual/app.admin.edits-768.png) · [expected](/expected/app.admin.edits-768.png) · [diff](/diff/app.admin.edits-768.png) — 3.054% differing pixels exceeds the 0.5% ceiling |
| app.admin.edits | 1024 | pixel | FAIL | 27058 | 3.4406% | 1024×768 vs 1024×768 | [actual](/actual/app.admin.edits-1024.png) · [expected](/expected/app.admin.edits-1024.png) · [diff](/diff/app.admin.edits-1024.png) — 3.441% differing pixels exceeds the 0.5% ceiling |
| app.admin.edits | 1440 | pixel | FAIL | 27722 | 2.1390% | 1440×900 vs 1440×900 | [actual](/actual/app.admin.edits-1440.png) · [expected](/expected/app.admin.edits-1440.png) · [diff](/diff/app.admin.edits-1440.png) — 2.139% differing pixels exceeds the 0.5% ceiling |
| app.admin.enrichment | 375 | pixel | FAIL | 131836 | 19.9752% | 375×1760 vs 375×1526 | [actual](/actual/app.admin.enrichment-375.png) · [expected](/expected/app.admin.enrichment-375.png) · [diff](/diff/app.admin.enrichment-375.png) — 19.975% differing pixels exceeds the 0.5% ceiling |
| app.admin.enrichment | 768 | pixel | FAIL | 456985 | 38.1921% | 768×1558 vs 768×1024 | [actual](/actual/app.admin.enrichment-768.png) · [expected](/expected/app.admin.enrichment-768.png) · [diff](/diff/app.admin.enrichment-768.png) — 38.192% differing pixels exceeds the 0.5% ceiling |
| app.admin.enrichment | 1024 | pixel | FAIL | 603510 | 38.9792% | 1024×1512 vs 1024×970 | [actual](/actual/app.admin.enrichment-1024.png) · [expected](/expected/app.admin.enrichment-1024.png) · [diff](/diff/app.admin.enrichment-1024.png) — 38.979% differing pixels exceeds the 0.5% ceiling |
| app.admin.enrichment | 1440 | pixel | FAIL | 801915 | 37.3248% | 1440×1492 vs 1440×970 | [actual](/actual/app.admin.enrichment-1440.png) · [expected](/expected/app.admin.enrichment-1440.png) · [diff](/diff/app.admin.enrichment-1440.png) — 37.325% differing pixels exceeds the 0.5% ceiling |
| app.admin.export | 375 | pixel | FAIL | 481691 | 52.3222% | 375×2455 vs 375×1425 | [actual](/actual/app.admin.export-375.png) · [expected](/expected/app.admin.export-375.png) · [diff](/diff/app.admin.export-375.png) — 52.322% differing pixels exceeds the 0.5% ceiling |
| app.admin.export | 768 | pixel | FAIL | 1000411 | 59.5075% | 768×2189 vs 768×1024 | [actual](/actual/app.admin.export-768.png) · [expected](/expected/app.admin.export-768.png) · [diff](/diff/app.admin.export-768.png) — 59.507% differing pixels exceeds the 0.5% ceiling |
| app.admin.export | 1024 | pixel | FAIL | 680011 | 49.7433% | 1024×1335 vs 1024×768 | [actual](/actual/app.admin.export-1024.png) · [expected](/expected/app.admin.export-1024.png) · [diff](/diff/app.admin.export-1024.png) — 49.743% differing pixels exceeds the 0.5% ceiling |
| app.admin.export | 1440 | pixel | FAIL | 657272 | 35.5759% | 1440×1283 vs 1440×900 | [actual](/actual/app.admin.export-1440.png) · [expected](/expected/app.admin.export-1440.png) · [diff](/diff/app.admin.export-1440.png) — 35.576% differing pixels exceeds the 0.5% ceiling |
| app.admin.github | 375 | pixel | FAIL | 1261542 | 77.6393% | 375×4333 vs 375×1065 | [actual](/actual/app.admin.github-375.png) · [expected](/expected/app.admin.github-375.png) · [diff](/diff/app.admin.github-375.png) — 77.639% differing pixels exceeds the 0.5% ceiling |
