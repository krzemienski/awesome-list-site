...
Run: `2026-09-16T04-18-25-368Z-52896`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2116964279` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 8 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T04:18:00.000Z` on both sides.  
Denominator: 3 pass / 4 fail / **7** pixel rows executed. 0 row-incomplete, 0 blocked, 0 evidence-only, 0 token-only, 0 aliases, 0 not selected.

Selected run (`--only app.admin.database,app.admin.subcategories,app.admin.resources,app.admin.edits,app.admin.enrichment,app.admin.linkhealth,app.admin.overview --width 1440`): 7 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.database | 1440 | pixel | FAIL | 12127 | 0.6689% | 1440×1258 vs 1440×1259 | [actual](/actual/app.admin.database-1440.png) · [expected](/expected/app.admin.database-1440.png) · [diff](/diff/app.admin.database-1440.png) — 0.669% differing pixels exceeds the 0.5% ceiling |
| app.admin.edits | 1440 | pixel | PASS | 662 | 0.0511% | 1440×900 vs 1440×900 | [actual](/actual/app.admin.edits-1440.png) · [expected](/expected/app.admin.edits-1440.png) · [diff](/diff/app.admin.edits-1440.png) |
...
| app.admin.overview | 1440 | pixel | FAIL | 17931 | 1.3836% | 1440×900 vs 1440×900 | [actual](/actual/app.admin.overview-1440.png) · [expected](/expected/app.admin.overview-1440.png) · [diff](/diff/app.admin.overview-1440.png) — 1.384% differing pixels exceeds the 0.5% ceiling |
| app.admin.resources | 1440 | pixel | FAIL | 27681 | 1.0182% | 1440×1888 vs 1440×1888 | [actual](/actual/app.admin.resources-1440.png) · [expected](/expected/app.admin.resources-1440.png) · [diff](/diff/app.admin.resources-1440.png) — 1.018% differing pixels exceeds the 0.5% ceiling |
| app.admin.subcategories | 1440 | pixel | FAIL | 25780 | 0.9772% | 1440×1832 vs 1440×1832 | [actual](/actual/app.admin.subcategories-1440.png) · [expected](/expected/app.admin.subcategories-1440.png) · [diff](/diff/app.admin.subcategories-1440.png) — 0.977% differing pixels exceeds the 0.5% ceiling |
...
| admin.jsx | `            {[
            ...
            ].map((row, i) => (` | `            {[["resources","1,993","14 MB","22h ago"],["categories","9","96 KB","28d ago"],["subcategories","92","56 KB","28d ago"],["users","16","80 KB","0s ago"],["resource_audit_log","6,221","2.7 MB","3h ago"],["enrichment_jobs","26","168 KB","22h ago"]].map((row, i) => (` | /api/admin/stats database.tableStats (count(*), pg_total_relation_size, newest updated_at/created_at vs frozen clock; admin session only) |
