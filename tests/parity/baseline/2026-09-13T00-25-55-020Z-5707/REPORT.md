...
Run: `2026-09-13T00-25-55-020Z-5707`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2139214555` "Nick" (torn down: local row deleted, Clerk user deleted, 1 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-13T00:25:00.000Z` on both sides.  
...
Selected run (`--only app.about --width 375,768,1024,1440`): 4 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.about | 375 | pixel | FAIL | 1472998 | 67.7007% | 375×5802 vs 375×2054 | [actual](/actual/app.about-375.png) · [expected](/expected/app.about-375.png) · [diff](/diff/app.about-375.png) — 67.701% differing pixels exceeds the 0.5% ceiling; backdrop-filter sets differ (app ["blur(14px)"] vs reference ["blur(14px)","blur(2px)"]) |
| app.about | 768 | pixel | FAIL | 2002209 | 66.3032% | 768×3932 vs 768×1417 | [actual](/actual/app.about-768.png) · [expected](/expected/app.about-768.png) · [diff](/diff/app.about-768.png) — 66.303% differing pixels exceeds the 0.5% ceiling; backdrop-filter sets differ (app ["blur(14px)"] vs reference ["blur(14px)","blur(2px)"]) |
| app.about | 1024 | pixel | FAIL | 2766592 | 72.6082% | 1024×3721 vs 1024×1086 | [actual](/actual/app.about-1024.png) · [expected](/expected/app.about-1024.png) · [diff](/diff/app.about-1024.png) — 72.608% differing pixels exceeds the 0.5% ceiling; backdrop-filter sets differ (app ["blur(14px)"] vs reference ["blur(14px)","blur(2px)"]) |
| app.about | 1440 | pixel | FAIL | 3699283 | 71.2409% | 1440×3606 vs 1440×1087 | [actual](/actual/app.about-1440.png) · [expected](/expected/app.about-1440.png) · [diff](/diff/app.about-1440.png) — 71.241% differing pixels exceeds the 0.5% ceiling; backdrop-filter sets differ (app ["blur(14px)"] vs reference ["blur(14px)","blur(2px)"]) |
