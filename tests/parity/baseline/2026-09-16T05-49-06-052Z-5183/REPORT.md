...
Run: `2026-09-16T05-49-06-052Z-5183`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2029232788` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 8 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T05:49:00.000Z` on both sides.  
Denominator: 3 pass / 4 fail / **7** pixel rows executed. 0 row-incomplete, 1 blocked, 0 evidence-only, 0 token-only, 0 aliases, 0 not selected.

Selected run (`--only app.admin.export,app.admin.linkhealth,app.admin.github,app.admin.resources,app.admin.categories,app.home.index,app.search,app.submit --width 375`): 8 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
| app.admin.export | 375 | pixel | PASS | 1235 | 0.2311% | 375×1425 vs 375×1425 | [actual](/actual/app.admin.export-375.png) · [expected](/expected/app.admin.export-375.png) · [diff](/diff/app.admin.export-375.png) |
| app.admin.github | 375 | pixel | FAIL | 10701 | 2.6794% | 375×1065 vs 375×1065 | [actual](/actual/app.admin.github-375.png) · [expected](/expected/app.admin.github-375.png) · [diff](/diff/app.admin.github-375.png) — 2.679% differing pixels exceeds the 0.5% ceiling |
| app.admin.linkhealth | 375 | pixel | FAIL | 27303 | 6.3256% | 375×1151 vs 375×1087 | [actual](/actual/app.admin.linkhealth-375.png) · [expected](/expected/app.admin.linkhealth-375.png) · [diff](/diff/app.admin.linkhealth-375.png) — 6.326% differing pixels exceeds the 0.5% ceiling |
| app.admin.resources | 375 | pixel | PASS | 2304 | 0.2332% | 375×2634 vs 375×2635 | [actual](/actual/app.admin.resources-375.png) · [expected](/expected/app.admin.resources-375.png) · [diff](/diff/app.admin.resources-375.png) |
