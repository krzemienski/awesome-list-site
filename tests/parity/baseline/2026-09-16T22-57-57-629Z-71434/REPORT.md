...
Run: `2026-09-16T22-57-57-629Z-71434`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 0)  
Identity: disposable Clerk admin `2050067706` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 2 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T22:57:00.000Z` on both sides.  
Denominator: 1 pass / 0 fail / **1** pixel rows executed. 0 row-incomplete, 0 blocked, 0 evidence-only, 0 token-only, 0 aliases, 0 not selected.

Selected run (`--only artifact.showcase --width 1440`): 1 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| artifact.showcase | 1440 | pixel | PASS | 2556 | 0.0156% | 1440×11378 vs 1440×11378 | [actual](/actual/artifact.showcase-1440.png) · [expected](/expected/artifact.showcase-1440.png) · [diff](/diff/artifact.showcase-1440.png) |
