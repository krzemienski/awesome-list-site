...
Run: `2026-09-16T02-15-11-737Z-20983`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2003471700` "Nick" (torn down: local row deleted, Clerk user deleted, 3 __qa_test_parity_ rows remaining)  
...
Selected run (`--only app.admin.researcher --width 1440`): 1 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.researcher | 1440 | pixel | FAIL | 1418706 | 50.7318% | 1440×1942 vs 1440×980 | [actual](/actual/app.admin.researcher-1440.png) · [expected](/expected/app.admin.researcher-1440.png) · [diff](/diff/app.admin.researcher-1440.png) — 50.732% differing pixels exceeds the 0.5% ceiling |
