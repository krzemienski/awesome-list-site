...
Run: `2026-09-15T05-53-16-120Z-15739`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 0)  
Identity: disposable Clerk admin `2058963685` "Nick" (torn down: local row deleted, Clerk user deleted, 1 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-15T05:53:00.000Z` on both sides.  
...
Selected run (`--only app.home.index --width 1024`): 1 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
