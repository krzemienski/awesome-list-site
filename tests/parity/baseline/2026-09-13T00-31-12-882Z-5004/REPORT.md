...
| app.home.index | 1024 | pixel | EVIDENCE (visitor-identity) | 2299393 | 63.6300% | 1024×1358 vs 1024×3529 | [actual](/actual/app.home.index-1024.png) · [expected](/expected/app.home.index-1024.png) · [diff](/diff/app.home.index-1024.png) — 63.630% differing pixels exceeds the 0.5% ceiling; backdrop-filter sets differ (app ["blur(14px)"] vs reference ["blur(14px)","blur(2px)"]) |
| app.home.index | 1440 | pixel | EVIDENCE (visitor-identity) | 2545160 | 59.3909% | 1440×1278 vs 1440×2976 | [actual](/actual/app.home.index-1440.png) · [expected](/expected/app.home.index-1440.png) · [diff](/diff/app.home.index-1440.png) — 59.391% differing pixels exceeds the 0.5% ceiling; backdrop-filter sets differ (app ["blur(14px)"] vs reference ["blur(14px)","blur(2px)"]) |
...
| app.shell.mobile-drawer | 375 | pixel | EVIDENCE (visitor-identity) | 1113429 | 54.4497% | 375×2683 vs 375×5453 | [actual](/actual/app.shell.mobile-drawer-375.png) · [expected](/expected/app.shell.mobile-drawer-375.png) · [diff](/diff/app.shell.mobile-drawer-375.png) — 54.450% differing pixels exceeds the 0.5% ceiling |
