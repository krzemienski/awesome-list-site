...
Run: `2026-09-16T03-41-09-898Z-23045`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2119945228` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 1 __qa_test_parity_ rows remaining)  
...
Selected run (`--only app.about --width 1440`): 1 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.about | 1440 | pixel | FAIL | 195728 | 3.2255% | 1440×4172 vs 1440×4214 | [actual](/actual/app.about-1440.png) · [expected](/expected/app.about-1440.png) · [diff](/diff/app.about-1440.png) — 3.225% differing pixels exceeds the 0.5% ceiling |
