...
Run: `2026-09-16T02-39-00-137Z-2091`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2131913747` "Nick" (torn down: local row deleted, Clerk user deleted, 5 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T02:39:00.000Z` on both sides.  
...
|---|---:|---|---|---:|---:|---|---|
| app.subcategory | 1440 | pixel | FAIL | 413086 | 7.2404% | 1440×3962 vs 1440×3845 | [actual](/actual/app.subcategory-1440.png) · [expected](/expected/app.subcategory-1440.png) · [diff](/diff/app.subcategory-1440.png) — 7.240% differing pixels exceeds the 0.5% ceiling |
