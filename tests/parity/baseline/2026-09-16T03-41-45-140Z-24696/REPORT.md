...
Run: `2026-09-16T03-41-45-140Z-24696`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2035873339` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 2 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T03:41:00.000Z` on both sides.  
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.database | 375 | pixel | FAIL | 26496 | 4.0077% | 375×1735 vs 375×1763 | [actual](/actual/app.admin.database-375.png) · [expected](/expected/app.admin.database-375.png) · [diff](/diff/app.admin.database-375.png) — 4.008% differing pixels exceeds the 0.5% ceiling |
| app.admin.database | 768 | pixel | FAIL | 49208 | 4.4036% | 768×1455 vs 768×1412 | [actual](/actual/app.admin.database-768.png) · [expected](/expected/app.admin.database-768.png) · [diff](/diff/app.admin.database-768.png) — 4.404% differing pixels exceeds the 0.5% ceiling |
| app.admin.database | 1024 | pixel | FAIL | 56983 | 4.2839% | 1024×1299 vs 1024×1259 | [actual](/actual/app.admin.database-1024.png) · [expected](/expected/app.admin.database-1024.png) · [diff](/diff/app.admin.database-1024.png) — 4.284% differing pixels exceeds the 0.5% ceiling |
| app.admin.database | 1440 | pixel | FAIL | 73689 | 3.9394% | 1440×1299 vs 1440×1259 | [actual](/actual/app.admin.database-1440.png) · [expected](/expected/app.admin.database-1440.png) · [diff](/diff/app.admin.database-1440.png) — 3.939% differing pixels exceeds the 0.5% ceiling |
...
| admin.jsx | `sub="2 admins · 1 contributor"` | `sub="7 admins · 4 contributors"` | /api/admin/users roles (admin session only) |
