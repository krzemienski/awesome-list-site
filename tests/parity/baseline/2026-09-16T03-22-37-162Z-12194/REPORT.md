...
Run: `2026-09-16T03-22-37-162Z-12194`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2052753262` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 1 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T03:22:00.000Z` on both sides.  
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.export | 1440 | pixel | FAIL | 40636 | 3.1355% | 1440×900 vs 1440×900 | [actual](/actual/app.admin.export-1440.png) · [expected](/expected/app.admin.export-1440.png) · [diff](/diff/app.admin.export-1440.png) — 3.135% differing pixels exceeds the 0.5% ceiling |
| app.admin.overview | 1440 | pixel | FAIL | 27272 | 2.1043% | 1440×900 vs 1440×900 | [actual](/actual/app.admin.overview-1440.png) · [expected](/expected/app.admin.overview-1440.png) · [diff](/diff/app.admin.overview-1440.png) — 2.104% differing pixels exceeds the 0.5% ceiling |
