...
Run: `2026-09-16T01-57-18-938Z-15170`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2086726371` "Nick" (torn down: local row deleted, Clerk user deleted, 0 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T01:57:00.000Z` on both sides.  
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.audit | 1440 | pixel | FAIL | 269827 | 6.2005% | 1440×2909 vs 1440×3022 | [actual](/actual/app.admin.audit-1440.png) · [expected](/expected/app.admin.audit-1440.png) · [diff](/diff/app.admin.audit-1440.png) — 6.201% differing pixels exceeds the 0.5% ceiling |
