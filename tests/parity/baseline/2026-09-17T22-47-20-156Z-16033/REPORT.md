...
Run: `2026-09-17T22-47-20-156Z-16033`  
Claim: **visitor-evidence-only**  
Gate: **NOT PASSED** (exit code 1)  
Identity: visitor (`--as visitor`, --as visitor)  
Frozen clock: `2026-09-17T22:47:00.000Z` on both sides.  
Denominator: 0 pass / 4 fail / **4** pixel rows executed. 0 row-incomplete, 0 blocked, 2 evidence-only, 0 token-only, 0 aliases, 0 not selected.

Selected run (`--only app.category,artifact.showcase,artifact.docs.forms --width 375,768`): 6 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
| artifact.docs.forms | 375 | pixel | FAIL | 28383 | 2.5280% | 375×2974 vs 375×2994 | [actual](/actual/artifact.docs.forms-375.png) · [expected](/expected/artifact.docs.forms-375.png) · [diff](/diff/artifact.docs.forms-375.png) — 2.528% differing pixels exceeds the 0.5% ceiling |
| artifact.docs.forms | 768 | pixel | FAIL | 52544 | 2.5107% | 768×2725 vs 768×2685 | [actual](/actual/artifact.docs.forms-768.png) · [expected](/expected/artifact.docs.forms-768.png) · [diff](/diff/artifact.docs.forms-768.png) — 2.511% differing pixels exceeds the 0.5% ceiling |
| artifact.showcase | 375 | pixel | FAIL | 1499988 | 20.7156% | 375×18899 vs 375×19309 | [actual](/actual/artifact.showcase-375.png) · [expected](/expected/artifact.showcase-375.png) · [diff](/diff/artifact.showcase-375.png) — 20.716% differing pixels exceeds the 0.5% ceiling |
| artifact.showcase | 768 | pixel | FAIL | 149196 | 1.5077% | 768×12885 vs 768×12795 | [actual](/actual/artifact.showcase-768.png) · [expected](/expected/artifact.showcase-768.png) · [diff](/diff/artifact.showcase-768.png) — 1.508% differing pixels exceeds the 0.5% ceiling |
