...
Run: `2026-09-16T19-06-14-290Z-33746`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2101773777` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 1 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T19:06:00.000Z` on both sides.  
...
Selected run (`--only app.admin.users,app.admin.github --width 375,768,1024`): 6 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
| app.admin.users | 768 | pixel | PASS | 4432 | 0.4680% | 768×1233 vs 768×1233 | [actual](/actual/app.admin.users-768.png) · [expected](/expected/app.admin.users-768.png) · [diff](/diff/app.admin.users-768.png) |
| app.admin.users | 1024 | pixel | FAIL | 6867 | 0.6108% | 1024×1098 vs 1024×1098 | [actual](/actual/app.admin.users-1024.png) · [expected](/expected/app.admin.users-1024.png) · [diff](/diff/app.admin.users-1024.png) — 0.611% differing pixels exceeds the 0.5% ceiling |
