...
Run: `2026-09-16T03-46-43-927Z-34311`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2120941926` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 2 __qa_test_parity_ rows remaining)  
...
Selected run (`--only app.admin.audit,app.admin.categories,app.admin.subcategories --width 375`): 3 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.audit | 375 | pixel | FAIL | 414726 | 25.1635% | 375×3359 vs 375×4395 | [actual](/actual/app.admin.audit-375.png) · [expected](/expected/app.admin.audit-375.png) · [diff](/diff/app.admin.audit-375.png) — 25.164% differing pixels exceeds the 0.5% ceiling |
| app.admin.categories | 375 | pixel | FAIL | 13433 | 2.9458% | 375×1203 vs 375×1216 | [actual](/actual/app.admin.categories-375.png) · [expected](/expected/app.admin.categories-375.png) · [diff](/diff/app.admin.categories-375.png) — 2.946% differing pixels exceeds the 0.5% ceiling |
| app.admin.subcategories | 375 | pixel | FAIL | 81107 | 7.7272% | 375×2799 vs 375×2621 | [actual](/actual/app.admin.subcategories-375.png) · [expected](/expected/app.admin.subcategories-375.png) · [diff](/diff/app.admin.subcategories-375.png) — 7.727% differing pixels exceeds the 0.5% ceiling |
