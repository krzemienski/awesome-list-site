...
Run: `2026-09-13T17-14-54-799Z-69524`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2140271880` "Nick" (torn down: local row deleted, Clerk user deleted, 0 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-13T17:14:00.000Z` on both sides.  
...
|---|---:|---|---|---:|---:|---|---|
| app.shell.palette | 375 | pixel | FAIL | 13903 | 0.6028% | 375×6149 vs 375×6150 | [actual](/actual/app.shell.palette-375.png) · [expected](/expected/app.shell.palette-375.png) · [diff](/diff/app.shell.palette-375.png) — 0.603% differing pixels exceeds the 0.5% ceiling |
| app.shell.palette | 768 | pixel | FAIL | 16578 | 0.5029% | 768×4292 vs 768×4292 | [actual](/actual/app.shell.palette-768.png) · [expected](/expected/app.shell.palette-768.png) · [diff](/diff/app.shell.palette-768.png) — 0.503% differing pixels exceeds the 0.5% ceiling |
| app.shell.palette | 1024 | pixel | PASS | 19157 | 0.4987% | 1024×3751 vs 1024×3751 | [actual](/actual/app.shell.palette-1024.png) · [expected](/expected/app.shell.palette-1024.png) · [diff](/diff/app.shell.palette-1024.png) |
| app.shell.palette | 1440 | pixel | PASS | 20438 | 0.4449% | 1440×3190 vs 1440×3190 | [actual](/actual/app.shell.palette-1440.png) · [expected](/expected/app.shell.palette-1440.png) · [diff](/diff/app.shell.palette-1440.png) |
