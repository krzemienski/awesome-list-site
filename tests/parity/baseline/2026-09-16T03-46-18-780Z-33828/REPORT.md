...
Run: `2026-09-16T03-46-18-780Z-33828`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2095365837` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 2 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T03:46:00.000Z` on both sides.  
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.enrichment | 1440 | pixel | FAIL | 139834 | 9.1784% | 1440×1058 vs 1440×970 | [actual](/actual/app.admin.enrichment-1440.png) · [expected](/expected/app.admin.enrichment-1440.png) · [diff](/diff/app.admin.enrichment-1440.png) — 9.178% differing pixels exceeds the 0.5% ceiling |
| app.admin.github | 1440 | pixel | FAIL | 56444 | 4.1877% | 1440×936 vs 1440×900 | [actual](/actual/app.admin.github-1440.png) · [expected](/expected/app.admin.github-1440.png) · [diff](/diff/app.admin.github-1440.png) — 4.188% differing pixels exceeds the 0.5% ceiling |
| app.admin.researcher | 1440 | pixel | FAIL | 94371 | 6.3075% | 1440×1039 vs 1440×980 | [actual](/actual/app.admin.researcher-1440.png) · [expected](/expected/app.admin.researcher-1440.png) · [diff](/diff/app.admin.researcher-1440.png) — 6.308% differing pixels exceeds the 0.5% ceiling |
