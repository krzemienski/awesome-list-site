...
Run: `2026-09-16T22-53-55-851Z-69389`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2103350801` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 2 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T22:53:00.000Z` on both sides.  
...
Selected run (`--only app.admin.researcher,app.admin.categories,app.admin.subcategories,app.admin.github --width 375`): 4 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
| app.admin.researcher | 375 | pixel | FAIL | 11745 | 2.5443% | 375×1231 vs 375×1211 | [actual](/actual/app.admin.researcher-375.png) · [expected](/expected/app.admin.researcher-375.png) · [diff](/diff/app.admin.researcher-375.png) — 2.544% differing pixels exceeds the 0.5% ceiling |
