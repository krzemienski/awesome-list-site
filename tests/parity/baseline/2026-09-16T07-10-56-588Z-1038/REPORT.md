...
Run: `2026-09-16T07-10-56-588Z-1038`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2015906335` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 8 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T07:10:00.000Z` on both sides.  
...
Selected run (`--only app.admin.users --width 1440`): 1 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.users | 1440 | pixel | FAIL | 10536 | 0.5287% | 1440×1384 vs 1440×1384 | [actual](/actual/app.admin.users-1440.png) · [expected](/expected/app.admin.users-1440.png) · [diff](/diff/app.admin.users-1440.png) — 0.529% differing pixels exceeds the 0.5% ceiling |
