...
Run: `2026-09-13T15-45-02-248Z-45251`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2030516453` "Nick" (torn down: local row deleted, Clerk user deleted, 0 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-13T15:45:00.000Z` on both sides.  
...
|---|---:|---|---|---:|---:|---|---|
| app.home.curated | 375 | pixel | FAIL | 86584 | 3.8094% | 375×6061 vs 375×6045 | [actual](/actual/app.home.curated-375.png) · [expected](/expected/app.home.curated-375.png) · [diff](/diff/app.home.curated-375.png) — 3.809% differing pixels exceeds the 0.5% ceiling |
| app.home.curated | 768 | pixel | FAIL | 17672 | 0.5991% | 768×3840 vs 768×3841 | [actual](/actual/app.home.curated-768.png) · [expected](/expected/app.home.curated-768.png) · [diff](/diff/app.home.curated-768.png) — 0.599% differing pixels exceeds the 0.5% ceiling |
| app.home.curated | 1024 | pixel | FAIL | 20364 | 0.5986% | 1024×3322 vs 1024×3322 | [actual](/actual/app.home.curated-1024.png) · [expected](/expected/app.home.curated-1024.png) · [diff](/diff/app.home.curated-1024.png) — 0.599% differing pixels exceeds the 0.5% ceiling |
| app.home.curated | 1440 | pixel | FAIL | 23279 | 0.5950% | 1440×2717 vs 1440×2717 | [actual](/actual/app.home.curated-1440.png) · [expected](/expected/app.home.curated-1440.png) · [diff](/diff/app.home.curated-1440.png) — 0.595% differing pixels exceeds the 0.5% ceiling |
| app.home.index | 375 | pixel | FAIL | 37525 | 1.6263% | 375×6153 vs 375×6150 | [actual](/actual/app.home.index-375.png) · [expected](/expected/app.home.index-375.png) · [diff](/diff/app.home.index-375.png) — 1.626% differing pixels exceeds the 0.5% ceiling |
| app.home.index | 768 | pixel | FAIL | 42757 | 1.2959% | 768×4296 vs 768×4292 | [actual](/actual/app.home.index-768.png) · [expected](/expected/app.home.index-768.png) · [diff](/diff/app.home.index-768.png) — 1.296% differing pixels exceeds the 0.5% ceiling |
| app.home.index | 1024 | pixel | FAIL | 56426 | 1.4675% | 1024×3755 vs 1024×3751 | [actual](/actual/app.home.index-1024.png) · [expected](/expected/app.home.index-1024.png) · [diff](/diff/app.home.index-1024.png) — 1.467% differing pixels exceeds the 0.5% ceiling |
| app.home.index | 1440 | pixel | FAIL | 31907 | 0.6946% | 1440×3190 vs 1440×3190 | [actual](/actual/app.home.index-1440.png) · [expected](/expected/app.home.index-1440.png) · [diff](/diff/app.home.index-1440.png) — 0.695% differing pixels exceeds the 0.5% ceiling |
| app.shell.mobile-drawer | 375 | pixel | FAIL | 44627 | 1.9341% | 375×6153 vs 375×6150 | [actual](/actual/app.shell.mobile-drawer-375.png) · [expected](/expected/app.shell.mobile-drawer-375.png) · [diff](/diff/app.shell.mobile-drawer-375.png) — 1.934% differing pixels exceeds the 0.5% ceiling |
| app.shell.mobile-drawer | 768 | pixel | FAIL | 50411 | 1.5279% | 768×4296 vs 768×4292 | [actual](/actual/app.shell.mobile-drawer-768.png) · [expected](/expected/app.shell.mobile-drawer-768.png) · [diff](/diff/app.shell.mobile-drawer-768.png) — 1.528% differing pixels exceeds the 0.5% ceiling |
| app.shell.mobile-drawer | 1024 | pixel | FAIL | 55468 | 1.4426% | 1024×3755 vs 1024×3751 | [actual](/actual/app.shell.mobile-drawer-1024.png) · [expected](/expected/app.shell.mobile-drawer-1024.png) · [diff](/diff/app.shell.mobile-drawer-1024.png) — 1.443% differing pixels exceeds the 0.5% ceiling |
| app.shell.mobile-drawer | 1440 | pixel | FAIL | 31907 | 0.6946% | 1440×3190 vs 1440×3190 | [actual](/actual/app.shell.mobile-drawer-1440.png) · [expected](/expected/app.shell.mobile-drawer-1440.png) · [diff](/diff/app.shell.mobile-drawer-1440.png) — 0.695% differing pixels exceeds the 0.5% ceiling |
| app.shell.palette | 375 | pixel | FAIL | 47608 | 2.0633% | 375×6153 vs 375×6150 | [actual](/actual/app.shell.palette-375.png) · [expected](/expected/app.shell.palette-375.png) · [diff](/diff/app.shell.palette-375.png) — 2.063% differing pixels exceeds the 0.5% ceiling |
| app.shell.palette | 768 | pixel | FAIL | 54361 | 1.6476% | 768×4296 vs 768×4292 | [actual](/actual/app.shell.palette-768.png) · [expected](/expected/app.shell.palette-768.png) · [diff](/diff/app.shell.palette-768.png) — 1.648% differing pixels exceeds the 0.5% ceiling |
| app.shell.palette | 1024 | pixel | FAIL | 63426 | 1.6495% | 1024×3755 vs 1024×3751 | [actual](/actual/app.shell.palette-1024.png) · [expected](/expected/app.shell.palette-1024.png) · [diff](/diff/app.shell.palette-1024.png) — 1.650% differing pixels exceeds the 0.5% ceiling |
| app.shell.palette | 1440 | pixel | FAIL | 42664 | 0.9288% | 1440×3190 vs 1440×3190 | [actual](/actual/app.shell.palette-1440.png) · [expected](/expected/app.shell.palette-1440.png) · [diff](/diff/app.shell.palette-1440.png) — 0.929% differing pixels exceeds the 0.5% ceiling |
...
Catalog snapshot `fe4ac015031bc406…` (9 categories, 1817 resources) bound to the design's `AV_*` globals; admin globals bound: AV_TOTAL_USERS, AV_USERS, AV_RECENT_ACTIVITY.
