...
Run: `2026-09-16T03-50-37-728Z-37242`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2114369177` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 2 __qa_test_parity_ rows remaining)  
...
Selected run (`--only app.admin.audit,app.admin.categories,app.admin.subcategories --width 1024`): 3 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.audit | 1024 | pixel | FAIL | 78126 | 2.3275% | 1024×3278 vs 1024×3278 | [actual](/actual/app.admin.audit-1024.png) · [expected](/expected/app.admin.audit-1024.png) · [diff](/diff/app.admin.audit-1024.png) — 2.327% differing pixels exceeds the 0.5% ceiling |
| app.admin.categories | 1024 | pixel | FAIL | 13969 | 1.3520% | 1024×1009 vs 1024×1009 | [actual](/actual/app.admin.categories-1024.png) · [expected](/expected/app.admin.categories-1024.png) · [diff](/diff/app.admin.categories-1024.png) — 1.352% differing pixels exceeds the 0.5% ceiling |
| app.admin.subcategories | 1024 | pixel | FAIL | 159541 | 7.7745% | 1024×2004 vs 1024×1876 | [actual](/actual/app.admin.subcategories-1024.png) · [expected](/expected/app.admin.subcategories-1024.png) · [diff](/diff/app.admin.subcategories-1024.png) — 7.775% differing pixels exceeds the 0.5% ceiling |
