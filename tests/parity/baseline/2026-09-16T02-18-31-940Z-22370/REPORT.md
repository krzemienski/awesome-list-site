...
Run: `2026-09-16T02-18-31-940Z-22370`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2002194972` "Nick" (torn down: local row deleted, Clerk user deleted, 3 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T02:18:00.000Z` on both sides.  
...
|---|---:|---|---|---:|---:|---|---|
| app.submit | 1440 | pixel | FAIL | 103737 | 4.9717% | 1440×1449 vs 1440×1398 | [actual](/actual/app.submit-1440.png) · [expected](/expected/app.submit-1440.png) · [diff](/diff/app.submit-1440.png) — 4.972% differing pixels exceeds the 0.5% ceiling |
