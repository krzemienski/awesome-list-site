...
Run: `2026-09-16T02-23-07-382Z-23782`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2057254947` "Nick" (torn down: local row deleted, Clerk user deleted, 4 __qa_test_parity_ rows remaining)  
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.users | 1440 | pixel | FAIL | 64719 | 3.8185% | 1440×1177 vs 1440×1160 | [actual](/actual/app.admin.users-1440.png) · [expected](/expected/app.admin.users-1440.png) · [diff](/diff/app.admin.users-1440.png) — 3.819% differing pixels exceeds the 0.5% ceiling |
