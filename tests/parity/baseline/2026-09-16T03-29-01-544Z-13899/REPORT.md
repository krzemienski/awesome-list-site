...
Run: `2026-09-16T03-29-01-544Z-13899`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2010241207` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 1 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T03:29:00.000Z` on both sides.  
...
Selected run (`--only app.admin.export,app.admin.overview,app.admin.github --width 1440`): 3 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.export | 1440 | pixel | FAIL | 11936 | 0.9210% | 1440×900 vs 1440×900 | [actual](/actual/app.admin.export-1440.png) · [expected](/expected/app.admin.export-1440.png) · [diff](/diff/app.admin.export-1440.png) — 0.921% differing pixels exceeds the 0.5% ceiling |
| app.admin.github | 1440 | pixel | FAIL | 83819 | 6.1595% | 1440×945 vs 1440×900 | [actual](/actual/app.admin.github-1440.png) · [expected](/expected/app.admin.github-1440.png) · [diff](/diff/app.admin.github-1440.png) — 6.160% differing pixels exceeds the 0.5% ceiling |
| app.admin.overview | 1440 | pixel | FAIL | 34570 | 2.6674% | 1440×900 vs 1440×900 | [actual](/actual/app.admin.overview-1440.png) · [expected](/expected/app.admin.overview-1440.png) · [diff](/diff/app.admin.overview-1440.png) — 2.667% differing pixels exceeds the 0.5% ceiling |
