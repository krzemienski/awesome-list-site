...
Run: `2026-09-16T02-23-34-339Z-23918`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2140199311` "Nick" (torn down: local row deleted, Clerk user deleted, 4 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T02:23:00.000Z` on both sides.  
...
Selected run (`--only app.admin.export --width 1440`): 1 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.export | 1440 | pixel | FAIL | 136200 | 10.5093% | 1440×900 vs 1440×900 | [actual](/actual/app.admin.export-1440.png) · [expected](/expected/app.admin.export-1440.png) · [diff](/diff/app.admin.export-1440.png) — 10.509% differing pixels exceeds the 0.5% ceiling |
