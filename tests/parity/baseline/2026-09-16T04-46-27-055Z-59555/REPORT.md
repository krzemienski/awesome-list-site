...
Run: `2026-09-16T04-46-27-055Z-59555`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2051855500` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 8 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T04:46:00.000Z` on both sides.  
...
Selected run (`--only app.admin.database,app.admin.overview,app.admin.research --width 1440`): 3 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.database | 1440 | pixel | FAIL | 11091 | 0.6118% | 1440×1259 vs 1440×1259 | [actual](/actual/app.admin.database-1440.png) · [expected](/expected/app.admin.database-1440.png) · [diff](/diff/app.admin.database-1440.png) — 0.612% differing pixels exceeds the 0.5% ceiling |
| app.admin.overview | 1440 | pixel | PASS | 964 | 0.0744% | 1440×900 vs 1440×900 | [actual](/actual/app.admin.overview-1440.png) · [expected](/expected/app.admin.overview-1440.png) · [diff](/diff/app.admin.overview-1440.png) |
| app.admin.research | 1440 | pixel | PASS | 590 | 0.0185% | 1440×2220 vs 1440×2220 | [actual](/actual/app.admin.research-1440.png) · [expected](/expected/app.admin.research-1440.png) · [diff](/diff/app.admin.research-1440.png) |
