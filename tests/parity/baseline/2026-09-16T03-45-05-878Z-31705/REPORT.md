...
Run: `2026-09-16T03-45-05-878Z-31705`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2114010449` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 3 __qa_test_parity_ rows remaining)  
...
|---|---:|---|---|---:|---:|---|---|
| app.about | 1440 | pixel | FAIL | 107352 | 1.7691% | 1440×4199 vs 1440×4214 | [actual](/actual/app.about-1440.png) · [expected](/expected/app.about-1440.png) · [diff](/diff/app.about-1440.png) — 1.769% differing pixels exceeds the 0.5% ceiling |
