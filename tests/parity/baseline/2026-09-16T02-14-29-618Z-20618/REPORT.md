...
Run: `2026-09-16T02-14-29-618Z-20618`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2078565321` "Nick" (torn down: local row deleted, Clerk user deleted, 2 __qa_test_parity_ rows remaining)  
...
Selected run (`--only app.admin.research --width 1440`): 1 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.research | 1440 | pixel | FAIL | 23969 | 1.8495% | 1440×900 vs 1440×900 | [actual](/actual/app.admin.research-1440.png) · [expected](/expected/app.admin.research-1440.png) · [diff](/diff/app.admin.research-1440.png) — 1.849% differing pixels exceeds the 0.5% ceiling |
