...
Run: `2026-09-16T22-38-33-173Z-63932`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2025288680` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 2 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T22:38:00.000Z` on both sides.  
Denominator: 4 pass / 2 fail / **6** pixel rows executed. 0 row-incomplete, 0 blocked, 0 evidence-only, 0 token-only, 0 aliases, 0 not selected.

Selected run (`--only artifact.docs.color,artifact.docs.buttons,artifact.docs.tokens --width 375,1440`): 6 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| artifact.docs.buttons | 375 | pixel | FAIL | 40709 | 2.9456% | 409×3379 vs 409×3363 | [actual](/actual/artifact.docs.buttons-375.png) · [expected](/expected/artifact.docs.buttons-375.png) · [diff](/diff/artifact.docs.buttons-375.png) — 2.946% differing pixels exceeds the 0.5% ceiling |
| artifact.docs.buttons | 1440 | pixel | FAIL | 42888 | 1.7346% | 1440×1717 vs 1440×1709 | [actual](/actual/artifact.docs.buttons-1440.png) · [expected](/expected/artifact.docs.buttons-1440.png) · [diff](/diff/artifact.docs.buttons-1440.png) — 1.735% differing pixels exceeds the 0.5% ceiling |
| artifact.docs.color | 375 | pixel | PASS | 404 | 0.0265% | 458×3331 vs 458×3331 | [actual](/actual/artifact.docs.color-375.png) · [expected](/expected/artifact.docs.color-375.png) · [diff](/diff/artifact.docs.color-375.png) |
| artifact.docs.color | 1440 | pixel | PASS | 248 | 0.0087% | 1440×1990 vs 1440×1990 | [actual](/actual/artifact.docs.color-1440.png) · [expected](/expected/artifact.docs.color-1440.png) · [diff](/diff/artifact.docs.color-1440.png) |
| artifact.docs.tokens | 375 | pixel | PASS | 404 | 0.0179% | 409×5526 vs 409×5526 | [actual](/actual/artifact.docs.tokens-375.png) · [expected](/expected/artifact.docs.tokens-375.png) · [diff](/diff/artifact.docs.tokens-375.png) |
| artifact.docs.tokens | 1440 | pixel | PASS | 248 | 0.0056% | 1440×3070 vs 1440×3070 | [actual](/actual/artifact.docs.tokens-1440.png) · [expected](/expected/artifact.docs.tokens-1440.png) · [diff](/diff/artifact.docs.tokens-1440.png) |
...
| admin.jsx | `            {[
            ...
            ].map((row, i) => (` | `            {[["resources","1,993","14 MB","41h ago"],["categories","9","96 KB","29d ago"],["subcategories","92","56 KB","29d ago"],["users","10","80 KB","0s ago"],["resource_audit_log","6,223","2.7 MB","5h ago"],["enrichment_jobs","26","168 KB","41h ago"]].map((row, i) => (` | /api/admin/stats database.tableStats (count(*), pg_total_relation_size, newest updated_at/created_at vs frozen clock; admin session only) |
