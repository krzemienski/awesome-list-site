...
Run: `2026-09-15T06-53-56-401Z-9144`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 0)  
Identity: disposable Clerk admin `2035155588` "Nick" (torn down: local row deleted, Clerk user deleted, 2 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-15T06:53:00.000Z` on both sides.  
...
Selected run (`--only app.home.curated --width 375,1024,1440`): 3 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
