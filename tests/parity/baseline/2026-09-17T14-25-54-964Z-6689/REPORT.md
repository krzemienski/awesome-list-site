...
Run: `2026-09-17T14-25-54-964Z-6689`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2025409753` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 0 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-17T14:25:00.000Z` on both sides.  
...
Selected run (`--only artifact.docs.color,artifact.docs.lists,artifact.docs.buttons,artifact.docs.forms,artifact.showcase --width 375`): 5 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| artifact.docs.buttons | 375 | pixel | FAIL | 201485 | 14.0590% | 375×3504 vs 409×3363 | [actual](/actual/artifact.docs.buttons-375.png) · [expected](/expected/artifact.docs.buttons-375.png) · [diff](/diff/artifact.docs.buttons-375.png) — 14.059% differing pixels exceeds the 0.5% ceiling |
| artifact.docs.color | 375 | pixel | FAIL | 409582 | 25.5510% | 375×3500 vs 458×3331 | [actual](/actual/artifact.docs.color-375.png) · [expected](/expected/artifact.docs.color-375.png) · [diff](/diff/artifact.docs.color-375.png) — 25.551% differing pixels exceeds the 0.5% ceiling |
| artifact.docs.forms | 375 | pixel | FAIL | 153819 | 13.1596% | 375×2879 vs 406×2771 | [actual](/actual/artifact.docs.forms-375.png) · [expected](/expected/artifact.docs.forms-375.png) · [diff](/diff/artifact.docs.forms-375.png) — 13.160% differing pixels exceeds the 0.5% ceiling |
| artifact.docs.lists | 375 | pixel | FAIL | 575033 | 37.0701% | 375×2862 vs 542×2664 | [actual](/actual/artifact.docs.lists-375.png) · [expected](/expected/artifact.docs.lists-375.png) · [diff](/diff/artifact.docs.lists-375.png) — 37.070% differing pixels exceeds the 0.5% ceiling |
| artifact.showcase | 375 | pixel | FAIL | 9479833 | 62.5834% | 375×19353 vs 741×20442 | [actual](/actual/artifact.showcase-375.png) · [expected](/expected/artifact.showcase-375.png) · [diff](/diff/artifact.showcase-375.png) — 62.583% differing pixels exceeds the 0.5% ceiling |
...
| admin.jsx | `            {[
            ...
            ].map((row, i) => (` | `            {[["resources","1,993","14 MB","2d ago"],["categories","9","96 KB","29d ago"],["subcategories","92","56 KB","29d ago"],["users","8","80 KB","0s ago"],["resource_audit_log","6,262","2.7 MB","16m ago"],["enrichment_jobs","26","168 KB","2d ago"]].map((row, i) => (` | /api/admin/stats database.tableStats (count(*), pg_total_relation_size, newest updated_at/created_at vs frozen clock; admin session only) |
