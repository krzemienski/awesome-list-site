...
Run: `2026-09-16T03-19-26-393Z-11505`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2138362320` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 1 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T03:19:00.000Z` on both sides.  
...
Selected run (`--only app.admin.export,app.admin.overview --width 1440`): 2 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.export | 1440 | pixel | FAIL | 96702 | 7.4616% | 1440×900 vs 1440×900 | [actual](/actual/app.admin.export-1440.png) · [expected](/expected/app.admin.export-1440.png) · [diff](/diff/app.admin.export-1440.png) — 7.462% differing pixels exceeds the 0.5% ceiling |
| app.admin.overview | 1440 | pixel | FAIL | 31510 | 2.4313% | 1440×900 vs 1440×900 | [actual](/actual/app.admin.overview-1440.png) · [expected](/expected/app.admin.overview-1440.png) · [diff](/diff/app.admin.overview-1440.png) — 2.431% differing pixels exceeds the 0.5% ceiling |
