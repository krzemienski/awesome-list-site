...
Run: `2026-09-17T23-47-56-735Z-29403`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2000261365` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 0 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-17T23:47:00.000Z` on both sides.  
...
| artifact.showcase | 375 | pixel | PASS | 864 | 0.0119% | 375×19349 vs 375×19349 | [actual](/actual/artifact.showcase-375.png) · [expected](/expected/artifact.showcase-375.png) · [diff](/diff/artifact.showcase-375.png) |
| artifact.showcase | 768 | pixel | PASS | 185 | 0.0019% | 768×12835 vs 768×12835 | [actual](/actual/artifact.showcase-768.png) · [expected](/expected/artifact.showcase-768.png) · [diff](/diff/artifact.showcase-768.png) |
