...
Run: `2026-09-18T00-01-34-770Z-32613`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 0)  
Identity: disposable Clerk admin `2122968431` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 0 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-18T00:01:00.000Z` on both sides.  
...
Selected run (`--only artifact.docs.forms --width 375`): 1 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
