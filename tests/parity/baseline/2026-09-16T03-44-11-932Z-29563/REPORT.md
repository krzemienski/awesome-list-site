...
Run: `2026-09-16T03-44-11-932Z-29563`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2120855356` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 2 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T03:44:00.000Z` on both sides.  
...
Selected run (`--only app.admin.database --width 375,768,1024,1440`): 4 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.database | 375 | pixel | FAIL | 32383 | 4.8982% | 375×1719 vs 375×1763 | [actual](/actual/app.admin.database-375.png) · [expected](/expected/app.admin.database-375.png) · [diff](/diff/app.admin.database-375.png) — 4.898% differing pixels exceeds the 0.5% ceiling |
| app.admin.database | 768 | pixel | FAIL | 36212 | 3.2767% | 768×1439 vs 768×1412 | [actual](/actual/app.admin.database-768.png) · [expected](/expected/app.admin.database-768.png) · [diff](/diff/app.admin.database-768.png) — 3.277% differing pixels exceeds the 0.5% ceiling |
| app.admin.database | 1024 | pixel | FAIL | 39694 | 3.0213% | 1024×1283 vs 1024×1259 | [actual](/actual/app.admin.database-1024.png) · [expected](/expected/app.admin.database-1024.png) · [diff](/diff/app.admin.database-1024.png) — 3.021% differing pixels exceeds the 0.5% ceiling |
| app.admin.database | 1440 | pixel | FAIL | 49696 | 2.6899% | 1440×1283 vs 1440×1259 | [actual](/actual/app.admin.database-1440.png) · [expected](/expected/app.admin.database-1440.png) · [diff](/diff/app.admin.database-1440.png) — 2.690% differing pixels exceeds the 0.5% ceiling |
