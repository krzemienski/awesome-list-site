...
Run: `2026-09-16T19-44-10-850Z-40836`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2041712963` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 1 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T19:44:00.000Z` on both sides.  
...
Selected run (`--only app.admin.users --width 1024`): 1 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.users | 1024 | pixel | FAIL | 6941 | 0.6173% | 1024×1098 vs 1024×1098 | [actual](/actual/app.admin.users-1024.png) · [expected](/expected/app.admin.users-1024.png) · [diff](/diff/app.admin.users-1024.png) — 0.617% differing pixels exceeds the 0.5% ceiling |
