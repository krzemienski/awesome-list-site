...
Run: `2026-09-16T05-04-55-877Z-65581`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2065612995` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 8 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T05:04:00.000Z` on both sides.  
...
Selected run (`--only app.admin.database,app.admin.audit --width 375,768,1024,1440`): 8 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.audit | 375 | pixel | FAIL | 414996 | 25.1799% | 375×3359 vs 375×4395 | [actual](/actual/app.admin.audit-375.png) · [expected](/expected/app.admin.audit-375.png) · [diff](/diff/app.admin.audit-375.png) — 25.180% differing pixels exceeds the 0.5% ceiling |
| app.admin.audit | 768 | pixel | FAIL | 876082 | 26.0679% | 768×3317 vs 768×4376 | [actual](/actual/app.admin.audit-768.png) · [expected](/expected/app.admin.audit-768.png) · [diff](/diff/app.admin.audit-768.png) — 26.068% differing pixels exceeds the 0.5% ceiling |
| app.admin.audit | 1024 | pixel | FAIL | 80160 | 2.3881% | 1024×3278 vs 1024×3278 | [actual](/actual/app.admin.audit-1024.png) · [expected](/expected/app.admin.audit-1024.png) · [diff](/diff/app.admin.audit-1024.png) — 2.388% differing pixels exceeds the 0.5% ceiling |
| app.admin.audit | 1440 | pixel | FAIL | 66576 | 1.4104% | 1440×3278 vs 1440×3278 | [actual](/actual/app.admin.audit-1440.png) · [expected](/expected/app.admin.audit-1440.png) · [diff](/diff/app.admin.audit-1440.png) — 1.410% differing pixels exceeds the 0.5% ceiling |
| app.admin.database | 375 | pixel | PASS | 3233 | 0.4890% | 375×1763 vs 375×1763 | [actual](/actual/app.admin.database-375.png) · [expected](/expected/app.admin.database-375.png) · [diff](/diff/app.admin.database-375.png) |
| app.admin.database | 768 | pixel | PASS | 3856 | 0.3556% | 768×1412 vs 768×1412 | [actual](/actual/app.admin.database-768.png) · [expected](/expected/app.admin.database-768.png) · [diff](/diff/app.admin.database-768.png) |
| app.admin.database | 1024 | pixel | PASS | 4145 | 0.3215% | 1024×1259 vs 1024×1259 | [actual](/actual/app.admin.database-1024.png) · [expected](/expected/app.admin.database-1024.png) · [diff](/diff/app.admin.database-1024.png) |
| app.admin.database | 1440 | pixel | PASS | 4265 | 0.2353% | 1440×1259 vs 1440×1259 | [actual](/actual/app.admin.database-1440.png) · [expected](/expected/app.admin.database-1440.png) · [diff](/diff/app.admin.database-1440.png) |
...
| admin.jsx | `            {[
            ...
            ].map((row, i) => (` | `            {[["resources","1,993","14 MB","23h ago"],["categories","9","96 KB","28d ago"],["subcategories","92","56 KB","28d ago"],["users","16","80 KB","0s ago"],["resource_audit_log","6,221","2.7 MB","4h ago"],["enrichment_jobs","26","168 KB","23h ago"]].map((row, i) => (` | /api/admin/stats database.tableStats (count(*), pg_total_relation_size, newest updated_at/created_at vs frozen clock; admin session only) |
