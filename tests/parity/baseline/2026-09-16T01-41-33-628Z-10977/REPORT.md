...
Run: `2026-09-16T01-41-33-628Z-10977`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2050850961` "Nick" (torn down: local row deleted, Clerk user deleted, 0 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T01:41:00.000Z` on both sides.  
...
|---|---:|---|---|---:|---:|---|---|
| app.subcategory | 1440 | pixel | FAIL | 989861 | 10.7072% | 1440×6420 vs 1440×5981 | [actual](/actual/app.subcategory-1440.png) · [expected](/expected/app.subcategory-1440.png) · [diff](/diff/app.subcategory-1440.png) — 10.707% differing pixels exceeds the 0.5% ceiling |
...
Catalog snapshot `136e4d6c0f4412d0…` (9 categories, 1816 resources) bound to the design's `AV_*` globals; admin globals bound: AV_RETAINED_OPERATIONS, AV_RETAINED_CATALOG, AV_TOTAL_USERS, AV_USERS, AV_RECENT_ACTIVITY, AV_PENDING_APPROVALS, AV_PENDING_RESOURCES, AV_AUDIT_LOGS, AV_AUDIT_TOTAL, AV_CONTACT_SUBMISSIONS.
