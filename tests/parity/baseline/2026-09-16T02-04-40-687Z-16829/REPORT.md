...
Run: `2026-09-16T02-04-40-687Z-16829`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2130828124` "Nick" (torn down: local row deleted, Clerk user deleted, 1 __qa_test_parity_ rows remaining)  
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.github | 1440 | pixel | FAIL | 3381805 | 72.7533% | 1440×3228 vs 1440×900 | [actual](/actual/app.admin.github-1440.png) · [expected](/expected/app.admin.github-1440.png) · [diff](/diff/app.admin.github-1440.png) — 72.753% differing pixels exceeds the 0.5% ceiling |
