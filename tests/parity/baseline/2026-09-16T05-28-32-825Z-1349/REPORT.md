...
Run: `2026-09-16T05-28-32-825Z-1349`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 0)  
Identity: disposable Clerk admin `2011313568` "Nick Krzemienski" (torn down: local row deleted, Clerk user deleted, 8 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-16T05:28:00.000Z` on both sides.  
Denominator: 2 pass / 0 fail / **2** pixel rows executed. 0 row-incomplete, 0 blocked, 0 evidence-only, 0 token-only, 0 aliases, 0 not selected.
...
| app.admin.audit | 768 | pixel | PASS | 1786 | 0.0531% | 768×4376 vs 768×4376 | [actual](/actual/app.admin.audit-768.png) · [expected](/expected/app.admin.audit-768.png) · [diff](/diff/app.admin.audit-768.png) |
