...
- candidate: `http://127.0.0.1:5000` → `../../../tmp/header-538/production-compare/candidate`
- compared at 2026-09-13T00:19:53.304Z · tool commit 7dfe06f7cad138a8364c4a421d752c06e641da1f · chromium chromium-1223 · axe-core 4.13.0
- routes: 1 · endpoints: 12 · strips: 4 (visual only, never a pixel gate)
- tracked deltas: **13** (1 routes, 8 endpoints)
...
|---|---|---|---|---|---|---|---|---|---|
| `/` | 200 | same | +1 / −15 | changed | same | 0/0 | 0/0 | title, testids | nav labels +127 −137 |
