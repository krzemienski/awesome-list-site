...
Captured: 2026-09-15T03:09:09.661Z
Base: `http://127.0.0.1:5000`
Browser: pinned Playwright Chromium via the required browser lease

## Scope

- Selection: geist:1440:admin-overview (targeted confirmation only).
...
- Rows: 1/1
- Visible computed accent users recorded: 19
- Accent users classified as violations: 0
...
- Accent discipline: no classified violations in captured rows.
- Ink tiers: 0 long visible p/li offender(s); review exact entries.
