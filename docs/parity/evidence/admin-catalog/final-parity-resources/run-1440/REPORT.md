...
Run: `2026-09-13T01-46-45-284Z-8539`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2084737338` "Nick" (torn down: local row deleted, Clerk user deleted, 2 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-13T01:46:00.000Z` on both sides.  
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.resources | 1440 | pixel | FAIL | 166180312 | 98.7363% | 1440×1535 vs 1440×116880 | [actual](actual/app.admin.resources-1440.png) · [expected](expected/app.admin.resources-1440.png) · [diff](diff/app.admin.resources-1440.png) — 98.736% differing pixels exceeds the 0.5% ceiling; backdrop-filter sets differ (app ["blur(14px)"] vs reference ["blur(14px)","blur(2px)"]) |
