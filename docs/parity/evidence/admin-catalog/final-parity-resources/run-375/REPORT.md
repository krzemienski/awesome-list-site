...
Run: `2026-09-13T01-45-35-521Z-8288`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2089919460` "Nick" (torn down: local row deleted, Clerk user deleted, 2 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-13T01:45:00.000Z` on both sides.  
...
Selected run (`--only app.admin.resources --width 375`): 1 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.resources | 375 | pixel | FAIL | 46129662 | 98.2889% | 375×2307 vs 375×125154 | [actual](actual/app.admin.resources-375.png) · [expected](expected/app.admin.resources-375.png) · [diff](diff/app.admin.resources-375.png) — 98.289% differing pixels exceeds the 0.5% ceiling; backdrop-filter sets differ (app ["blur(14px)"] vs reference ["blur(14px)","blur(2px)"]) |
