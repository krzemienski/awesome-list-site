...
Run: `2026-09-13T01-48-15-298Z-8804`  
Claim: **selected-rows-diagnostic**  
Gate: **NOT PASSED** (exit code 1)  
Identity: disposable Clerk admin `2108811145` "Nick" (torn down: local row deleted, Clerk user deleted, 2 __qa_test_parity_ rows remaining)  
Frozen clock: `2026-09-13T01:48:00.000Z` on both sides.  
...
Selected run (`--only app.admin.resources --width 768,1024`): 2 rows executed; rows outside the selection are not listed and the gate is diagnostic only.
...
|---|---:|---|---|---:|---:|---|---|
| app.admin.resources | 768 | pixel | FAIL | 94854150 | 98.7377% | 768×1676 vs 768×125087 | [actual](actual/app.admin.resources-768.png) · [expected](expected/app.admin.resources-768.png) · [diff](diff/app.admin.resources-768.png) — 98.738% differing pixels exceeds the 0.5% ceiling; backdrop-filter sets differ (app ["blur(14px)"] vs reference ["blur(14px)","blur(2px)"]) |
| app.admin.resources | 1024 | pixel | FAIL | 126384335 | 98.6999% | 1024×1703 vs 1024×125048 | [actual](actual/app.admin.resources-1024.png) · [expected](expected/app.admin.resources-1024.png) · [diff](diff/app.admin.resources-1024.png) — 98.700% differing pixels exceeds the 0.5% ceiling; backdrop-filter sets differ (app ["blur(14px)"] vs reference ["blur(14px)","blur(2px)"]) |
