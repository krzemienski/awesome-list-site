...
description: |
  Transform podcast episodes into SEO-optimized blog posts in a conversational voice.
  Use when: repurposing podcast transcripts as written content, driving SEO traffic from blog to podcast, creating searchable records of episode insights
  Covers: angle selection (one insight deep-dive), conversational voice, SEO headers, guest representation, quote mining, hyperlink integration, 3-phase workflow (prep/write/optimize)
  Keywords: podcast, blog-post, transcript, seo, repurpose, guest-interview, narrative, content-creation
---
...
|---------|---------------|-----------------|
| Summarizing all guest topics equally | Reads like show notes, not a blog post; no narrative energy or depth | Pick ONE angle and go deep — leave readers wanting the full episode |
| Generic SEO headers ("Understanding Motivation") | Won't rank; doesn't match audience search intent | Use audience-specific keywords: "Why [Audience] Should Rethink [Practice]" |
| Burying guest introduction until mid-article | Readers don't know who's speaking; credibility is absent when needed most | Introduce guest naturally within the first 200 words with relevant credentials |
| Exceeding 5 direct quotes or quoting mundane statements | Over-quoting dilutes impact; mundane quotes add no value | Use 3-5 quotes max, only for vivid/surprising statements that can't be paraphrased |
| Linking to commercial sites instead of peer-reviewed sources | Undermines credibility of research-backed claims | Link to NIH/PubMed, academic journals, university research centers |

## When NOT to Use

- Quick social media captions — use `social-content-creation` instead
- Episode summaries or show notes — this creates narrative, not summaries
- Raw transcript cleanup — use `transcript-polisher` first
- Non-podcast content repurposing — this is podcast-specific

## Conflicts

- `social-content-creation`: That skill creates short social posts; this skill creates long-form blog posts. Use both in sequence (blog first, then social excerpts)
- `content-research-writer`: That skill writes original research articles; this skill repurposes existing podcast conversations. Choose based on source material
