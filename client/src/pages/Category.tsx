...
export default function Category() {
  ...
  if (isLoading) {
    // Skeleton mirrors the loaded layout's vertical rhythm (back button, title
    // block, filter bar, results-count) so the card grid starts at the same Y
    // offset — otherwise the header pops in on load and shoves the grid down
