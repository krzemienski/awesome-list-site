...
export default function Category() {
  ...
  const toDbResource = (resource: Resource, dbResource: any): DbResource => ({
    ...
    linkHealthStatus: dbResource?.linkHealthStatus || null,
    lastLinkCheck: dbResource?.lastLinkCheck || null,
    linkCheckResponseTime: dbResource?.linkCheckResponseTime || null,
