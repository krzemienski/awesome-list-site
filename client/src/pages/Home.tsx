...
import ResourceSearchCommand from "@/components/ui/resource-search-command";
...
type LayoutType = "cards" | "list" | "compact" | "table";
...
export default function Home({ awesomeList, isLoading }: HomeProps) {
  ...
  // Handle resource selection from command search
            ...
            <>
              ...
              {layout === "table" ? (
                ...
                <div className="space-y-1 mb-8">
                  {paginatedResources.map((resource, index) => (
                    <MobileResourcePopover key={`${resource.title}-${resource.url}`} resource={resource}>
                      <Card className="p-4 border-l-4 border-l-primary hover:bg-accent/50 transition-colors min-h-[60px] flex items-center">
                ...
                <div className="grid grid-cols-2 gap-2 mb-8">
                  {paginatedResources.map((resource, index) => (
                    <MobileResourcePopover key={`${resource.title}-${resource.url}`} resource={resource}>
                      <Card className="p-3 hover:bg-accent/50 transition-colors min-h-[120px] flex flex-col">
