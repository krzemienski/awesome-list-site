...
export default function SEOHead({
  ...
  const pageDescription = description || (
    category
      ...
      : awesomeList
      ? `${awesomeList.description || SITE_TAGLINE} Explore ${awesomeList.resources?.length || '2000+'} carefully curated resources across ${awesomeList.categories?.length || '80+'} categories.`
      : SITE_TAGLINE
  );
