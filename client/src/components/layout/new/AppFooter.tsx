      ...
      <div className="site-footer-inner">
        <nav className="footer-grid" aria-label="Footer">
          ...
          <Column title="PROJECT">
            ...
            <button type="button" onClick={openCookieSettings} data-testid="footer-cookie-settings" className="nav-link footer-link footer-cookie-settings">Cookie settings</button>
          </Column>
          <Column title="SOURCE">
